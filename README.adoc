...
Replacing `<spec>` with is one of the following:
...
=== Authoring documentation (as tests, for extended examples, and for macros) for Substrate packages
