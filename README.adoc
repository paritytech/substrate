...
For Unix based operating systems, you shoudl run the following commands:
...
2. Next, you need to install Rust:
    ...
    * Details instructions are provided by the https://doc.rust-lang.org/book/ch01-01-installation.html#installing-rustup-on-windows[Rust Book]
