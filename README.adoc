...
=== Joining the Krumme Lanke Testnet

If you would like to join the Krumme Lanke testnet, you need version 0.2.42.
...
Optional: Choose your own name:

[source, shell]
cargo run -- --name=my_custom_name

If you are successful, you will see your node syncing at https://telemetry.polkadot.io/#/Krumme%20Lanke 
