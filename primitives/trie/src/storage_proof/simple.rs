...
pub struct Flat(ProofNodes);

#[derive(Debug, PartialEq, Eq, Clone, Encode, Decode)]
pub struct Full(ChildrenProofMap<ProofNodes>);
...
#[cfg(feature = "std")]
impl<Hash: Default + Clone + Eq + sp_std::hash::Hash> RegStorageProof<Hash> for Flat {
...
#[cfg(feature = "std")]
impl<Hash: Default + Clone + Eq + sp_std::hash::Hash> RegStorageProof<Hash> for Full {
	const INPUT_KIND: InputKind = InputKind::None;
