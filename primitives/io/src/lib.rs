...
pub trait EllipticCurves {
	...
	fn bls12_377_mul_projective_g1(base: Vec<u8>, scalar: Vec<u8>) -> Result<Vec<u8>, ()> {
		sp_crypto_ec_utils::bls12_377::mul_projective_g1(base, scalar)
	}
	...
	fn bw6_761_mul_projective_g1(base: Vec<u8>, scalar: Vec<u8>) -> Result<Vec<u8>, ()> {
		sp_crypto_ec_utils::bw6_761::mul_projective_g1(base, scalar)
	}
	...
	fn ed_on_bls12_381_bandersnatch_te_mul_projective(
		...
		sp_crypto_ec_utils::ed_on_bls12_381_bandersnatch::te_mul_projective(base, scalar)
	}
	...
	fn ed_on_bls12_381_bandersnatch_sw_mul_projective(
		...
		sp_crypto_ec_utils::ed_on_bls12_381_bandersnatch::sw_mul_projective(base, scalar)
	}
	...
	fn ed_on_bls12_381_bandersnatch_te_msm(
		...
		sp_crypto_ec_utils::ed_on_bls12_381_bandersnatch::te_msm(bases, scalars)
	}
	...
	fn ed_on_bls12_381_bandersnatch_sw_msm(
		...
		sp_crypto_ec_utils::ed_on_bls12_381_bandersnatch::sw_msm(bases, scalars)
	}
	...
	fn ed_on_bls12_377_mul_projective(base: Vec<u8>, scalar: Vec<u8>) -> Result<Vec<u8>, ()> {
		sp_crypto_ec_utils::ed_on_bls12_377::mul_projective(base, scalar)
	}

	/// Compute msm on ed_on_bls12_377
	fn ed_on_bls12_377_msm(bases: Vec<u8>, scalars: Vec<u8>) -> Result<Vec<u8>, ()> {
		sp_crypto_ec_utils::ed_on_bls12_377::msm(bases, scalars)
	}
}
