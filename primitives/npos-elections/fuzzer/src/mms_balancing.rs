...
use sp_npos_elections::{
	assignment_ratio_to_staked_normalized, mms, to_supports, ElectionResult, EvaluateSupport,
	VoteWeight,
};
	...
	loop {
		fuzz!(|data: (usize, usize, usize, usize, u64)| {
			...
			let balanced: ElectionResult<AccountId, Perbill> =
				mms(to_elect, candidates, voters, iterations, 0).unwrap();
