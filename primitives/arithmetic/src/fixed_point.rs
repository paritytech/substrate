    ...
    fn saturating_abs(self) -> Self {
        ...
        if inner >= Self::Inner::zero() {
            ...
            Self::from_inner(
                inner
                    .checked_neg()
                    .unwrap_or_else(|| Self::Inner::max_value()),
            )
        }
    }
    ...
    (
        ...
        mod $test_mod {
            ...
            fn checked_mul_int_works() {
                ...
                // Max - 1.
                assert_eq!(
                    a.checked_mul_int((i128::max_value() - 1) / 2),
                    Some(i128::max_value() - 1)
                );
                // Max.
                assert_eq!(
                    a.checked_mul_int(i128::max_value() / 2),
                    Some(i128::max_value() - 1)
                );
                // Max + 1 => None.
                ...
                if $name::SIGNED {
                    // Min - 1.
                    assert_eq!(
                        a.checked_mul_int((i128::min_value() + 1) / 2),
                        Some(i128::min_value() + 2)
                    );
                    // Min.
                    assert_eq!(
                        a.checked_mul_int(i128::min_value() / 2),
                        Some(i128::min_value())
                    );
                    // Min + 1 => None.
                    ...
                    assert_eq!(
                        b.checked_mul_int(i128::max_value()),
                        Some(i128::max_value() / -2)
                    );
                    assert_eq!(
                        b.checked_mul_int(i128::min_value()),
                        Some(i128::min_value() / -2)
                    );
                }
                ...
                assert_eq!(
                    a.checked_mul_int(i128::max_value()),
                    Some(i128::max_value() / 2)
                );
                assert_eq!(
                    a.checked_mul_int(i128::min_value()),
                    Some(i128::min_value() / 2)
                );
            ...
            fn saturating_mul_int_works() {
                ...
                // Max - 1.
                assert_eq!(
                    a.saturating_mul_int((i128::max_value() - 1) / 2),
                    i128::max_value() - 1
                );
                // Max.
                assert_eq!(
                    a.saturating_mul_int(i128::max_value() / 2),
                    i128::max_value() - 1
                );
                // Max + 1 => saturates to max.
                assert_eq!(
                    a.saturating_mul_int(i128::max_value() / 2 + 1),
                    i128::max_value()
                );

                // Min - 1.
                assert_eq!(
                    a.saturating_mul_int((i128::min_value() + 1) / 2),
                    i128::min_value() + 2
                );
                // Min.
                assert_eq!(
                    a.saturating_mul_int(i128::min_value() / 2),
                    i128::min_value()
                );
                // Min + 1 => saturates to min.
                assert_eq!(
                    a.saturating_mul_int(i128::min_value() / 2 - 1),
                    i128::min_value()
                );
                ...
                if $name::SIGNED {
                    ...
                    assert_eq!(
                        b.saturating_mul_int(i128::max_value()),
                        i128::max_value() / -2
                    );
                    assert_eq!(
                        b.saturating_mul_int(i128::min_value()),
                        i128::min_value() / -2
                    );
                ...
                assert_eq!(
                    a.saturating_mul_int(i128::max_value()),
                    i128::max_value() / 2
                );
                assert_eq!(
                    a.saturating_mul_int(i128::min_value()),
                    i128::min_value() / 2
                );
            ...
            fn saturating_mul_acc_int_works() {
                ...
                assert_eq!(
                    $name::one().saturating_mul_acc_int(i128::max_value()),
                    i128::max_value()
                );
                assert_eq!(
                    $name::one().saturating_mul_acc_int(i128::min_value()),
                    i128::min_value()
                );

                assert_eq!(
                    $name::one().saturating_mul_acc_int(u128::max_value() / 2),
                    u128::max_value() - 1
                );
                assert_eq!(
                    $name::one().saturating_mul_acc_int(u128::min_value()),
                    u128::min_value()
                );
                ...
                if $name::SIGNED {
                    ...
                    assert_eq!(
                        a.saturating_mul_acc_int(u128::max_value() - 1),
                        u128::max_value() / 2
                    );
                }
            }
            ...
            fn saturating_pow_should_work() {
                ...
                assert_eq!(
                    $name::saturating_from_integer(1).saturating_pow(usize::max_value()),
                    (1).into()
                );
                ...
                if $name::SIGNED {
                    ...
                    assert_eq!(
                        $name::saturating_from_integer(-1).saturating_pow(usize::max_value() - 1),
                        (1).into()
                    );
                }
                ...
                assert_eq!(
                    $name::saturating_from_integer(0).saturating_pow(usize::max_value()),
                    (0).into()
                );
                assert_eq!(
                    $name::saturating_from_integer(2).saturating_pow(usize::max_value()),
                    $name::max_value()
                );
            }
