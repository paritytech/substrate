...
use crate::{
    traits::{Bounded, SaturatedConversion, Saturating, UniqueSaturatedInto},
...
mod tests {
    ...
    fn saturating_mul_should_work() {
        ...
        assert_eq!(
            Fixed128::from_natural(125).saturating_mul(a).deconstruct(),
            -125 * DIV
        );
    ...
    fn saturating_mul_int_works() {
        ...
        assert_eq!(
            max().saturating_mul_int(&2i128),
            340_282_366_920_938_463_463
        );

        assert_eq!(
            max().saturating_mul_int(&i128::min_value()),
            i128::min_value()
        );

        assert_eq!(
            min().saturating_mul_int(&i128::max_value()),
            i128::min_value()
        );

        assert_eq!(
            min().saturating_mul_int(&i128::min_value()),
            i128::max_value()
        );
    }
    ...
    fn checked_div_int_should_work() {
        ...
        let result = Fixed128::from_natural(result)
            .checked_mul_int(&-2i128)
            .unwrap();
    ...
    fn recip_should_work() {
        ...
        let a = Fixed128::from_rational(1, NonZeroI128::new(2).unwrap());
        assert_eq!(
            a.recip().unwrap().checked_mul(&a),
            Some(Fixed128::from_natural(1))
        );
    ...
    fn saturating_abs_should_work() {
        // normal
        assert_eq!(
            Fixed128::from_parts(1).saturating_abs(),
        ...
        // saturating
        assert_eq!(
            Fixed128::min_value().saturating_abs(),
            Fixed128::max_value()
        );
    }
    ...
    fn fmt_should_work() {
        ...
        assert_eq!(
            format!("{:?}", positive_fractional),
            "Fixed128(0.000000000000000001)"
        );
        let negative_fractional = Fixed128::from_parts(-1);
        assert_eq!(
            format!("{:?}", negative_fractional),
            "Fixed128(-0.000000000000000001)"
        );
    ...
    fn saturating_pow_should_work() {
        assert_eq!(
            Fixed128::from_natural(2).saturating_pow(0),
            Fixed128::from_natural(1)
        );
        assert_eq!(
            Fixed128::from_natural(2).saturating_pow(1),
            Fixed128::from_natural(2)
        );
        assert_eq!(
            Fixed128::from_natural(2).saturating_pow(2),
            Fixed128::from_natural(4)
        );
        assert_eq!(
            Fixed128::from_natural(2).saturating_pow(3),
            Fixed128::from_natural(8)
        );
        assert_eq!(
            Fixed128::from_natural(2).saturating_pow(50),
            Fixed128::from_natural(1125899906842624)
        );

        assert_eq!(
            Fixed128::from_natural(1).saturating_pow(1000),
            Fixed128::from_natural(1)
        );
        assert_eq!(
            Fixed128::from_natural(-1).saturating_pow(1000),
        ...
        assert_eq!(
            Fixed128::from_natural(-1).saturating_pow(1001),
            Fixed128::from_natural(-1)
        );
        assert_eq!(
            Fixed128::from_natural(1).saturating_pow(usize::max_value()),
            Fixed128::from_natural(1)
        );
        assert_eq!(
            Fixed128::from_natural(-1).saturating_pow(usize::max_value()),
        ...
        assert_eq!(
            Fixed128::from_natural(-1).saturating_pow(usize::max_value() - 1),
            Fixed128::from_natural(1)
        );

        assert_eq!(
            Fixed128::from_natural(114209).saturating_pow(4),
            Fixed128::from_natural(170137997018538053761)
        );
        assert_eq!(
            Fixed128::from_natural(114209).saturating_pow(5),
            Fixed128::max_value()
        );
        ...
        assert_eq!(
            Fixed128::from_natural(0).saturating_pow(usize::max_value()),
            Fixed128::from_natural(0)
        );
        assert_eq!(
            Fixed128::from_natural(2).saturating_pow(usize::max_value()),
            Fixed128::max_value()
        );
    }
}
