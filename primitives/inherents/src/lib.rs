...
pub trait ProvideInherent {
	...
	///
	/// This function will be called for each extrinsic with no signature and with the call
	/// [`Self::Call`]. Thus it will be called for both inherents and unsigned transactions.
	///
	/// NOTE: Checking the inherent is optional and can be omitted.
