...
use crate::traits::{
	self, Member, RuntimeArithmetic, SimpleBitOps, Hash as HashT,
...
impl<Number, Hash> traits::Header for Header<Number, Hash> where
	Number: Member + MaybeSerializeDeserialize + Debug + sp_std::hash::Hash + MaybeDisplay +
		RuntimeArithmetic + Codec + Copy + Into<U256> + TryFrom<U256> + sp_std::str::FromStr +
		MaybeMallocSizeOf,
	Hash: HashT,
...
impl<Number, Hash> Header<Number, Hash> where
	Number: Member + sp_std::hash::Hash + Copy + MaybeDisplay + RuntimeArithmetic + Codec + Into<U256> + TryFrom<U256>,
	Hash: HashT,
