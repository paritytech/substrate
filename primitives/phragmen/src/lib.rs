...
//! Rust implementation of the Phragmén election algorithm. This is used in several FRAME modules to
...
///
/// This, at the current version, resembles the `Exposure` defined in the staking FRAME module, yet
