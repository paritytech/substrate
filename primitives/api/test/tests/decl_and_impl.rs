...
mock_impl_runtime_apis! {
	impl Api<Block> for MockApi {
		...
		#[advanced]
		fn same_name(_: <Block as sp_runtime::traits::HeaderProvider>::Hash) -> Result<(), ApiError> {
			Ok(().into())
		}

		#[advanced]
		fn wild_card(at: <Block as sp_runtime::traits::HeaderProvider>::Hash, _: u32) -> Result<(), ApiError> {
