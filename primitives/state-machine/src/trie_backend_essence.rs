...
pub trait TrieBackendStorage<H: Hasher>: Send + Sync {
	/// TODO Here we got very few inner mutability (ProvingBackend (is it still use?)).
	/// Consider just making this storage Clone.
	type AsyncStorage: TrieBackendStorage<H>;
