...
fn execution_flat_proof_check_on_trie_backend<H, N, Exec>(
...
fn read_child_proof_check_on_flat_proving_backend<H>(
	proving_backend: &TrieBackend<MemoryDB<H>, H>,
	child_info: &ChildInfo,
	key: &[u8],
) -> Result<Option<Vec<u8>>, Box<dyn Error>>
...
fn read_child_proof_check_on_proving_backend<H>(
	proving_backend: &TrieBackend<ChildrenProofMap<MemoryDB<H>>, H>,
	child_info: &ChildInfo,
	key: &[u8],
) -> Result<Option<Vec<u8>>, Box<dyn Error>>
