...
pub fn mul_projective_g2(base: Vec<u8>, scalar: Vec<u8>) -> Vec<u8> {
	...
	let result = <ark_bls12_377::g2::Config as SWCurveConfig>::mul_projective(&base, &scalar);
...
pub fn mul_projective_g1(base: Vec<u8>, scalar: Vec<u8>) -> Vec<u8> {
	...
	let result = <ark_bls12_377::g1::Config as SWCurveConfig>::mul_projective(&base, &scalar);
...
pub fn mul_affine_g1(base: Vec<u8>, scalar: Vec<u8>) -> Vec<u8> {
	...
	let result = <ark_bls12_377::g1::Config as SWCurveConfig>::mul_affine(&base, &scalar);
...
pub fn mul_affine_g2(base: Vec<u8>, scalar: Vec<u8>) -> Vec<u8> {
	...
	let result = <ark_bls12_377::g2::Config as SWCurveConfig>::mul_affine(&base, &scalar);
