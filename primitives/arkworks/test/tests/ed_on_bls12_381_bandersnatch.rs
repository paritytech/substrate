...
use ark_std::vec::Vec;
use sp_ark_ed_on_bls12_381_bandersnatch::HostFunctions;
...
test_group!(sw; sp_ark_ed_on_bls12_381_bandersnatch::SWProjective<super::Host>; sw);
test_group!(te; sp_ark_ed_on_bls12_381_bandersnatch::EdwardsProjective<super::Host>; te);
