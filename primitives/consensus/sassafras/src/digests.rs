...
#[derive(Clone, RuntimeDebug, Encode, Decode)]
pub struct RawSecondaryPreDigest<VRFOutput=schnorrkel::RawVRFOutput> {
	/// Authority index.
	pub authority_index: AuthorityIndex,
	/// Slot number.
	pub slot_number: SlotNumber,
...
pub type SecondaryPreDigest = RawSecondaryPreDigest<schnorrkel::VRFOutput>;
...
pub enum RawPreDigest<VRFOutput=schnorrkel::RawVRFOutput, VRFProof=schnorrkel::RawVRFProof> {
	...
	Secondary(RawSecondaryPreDigest<VRFOutput>),
}
...
#[derive(Clone, RuntimeDebug, Encode, Decode)]
pub struct RawPostBlockDescriptor<VRFOutput=schnorrkel::RawVRFOutput> {
...
pub type PostBlockDescriptor = RawPostBlockDescriptor<schnorrkel::VRFOutput>;
