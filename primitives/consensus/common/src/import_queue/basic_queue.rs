...
///
/// This polls the `block_import_receiver` for new blocks to import and than awaits on importing
/// these blocks. After each block is imported, this async function yields once to give other
/// futures the possibility to be run.
///
...
///
/// This will yield after each imported block once, to ensure that other futures can be called as
/// well.
