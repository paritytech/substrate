...
use ark_serialize::{Compress, SerializationError, CanonicalSerialize, Validate};
...
impl SWCurveConfig for Config {
	...
	fn mul_projective(base: &Projective<Self>, scalar: &[u64]) -> Projective<Self> {
		...
		let result = sp_io::crypto::bls12_381_mul_projective_g2(serialized_base, serialized_scalar);
	...
	fn mul_affine(base: &Affine<Self>, scalar: &[u64]) -> Projective<Self> {
		...
		let result = sp_io::crypto::bls12_381_mul_affine_g2(serialized_base, serialized_scalar);
