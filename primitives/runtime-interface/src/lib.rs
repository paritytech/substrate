...
//! | `Vec<T> where T: Encode`|`u64`|`let e = v.encode();`<br><code>e.len() 32bit << 32 &#124; e.as_ptr() 32bit</code>|
//! | `&[T] where T: Encode`|`u64`|`let e = v.encode();`<br><code>e.len() 32bit << 32 &#124; e.as_ptr() 32bit</code>|
//! | `[u8; N]` | `u32` | `v.as_ptr()` |
//! | `*const T` | `u32` | `Identity` |
//! | `Option<T>` | `u64` | `let e = v.encode();`<br><code>e.len() 32bit << 32 &#124; e.as_ptr() 32bit</code> |
