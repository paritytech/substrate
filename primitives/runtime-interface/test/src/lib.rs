...
#[test]
fn test_return_data() {
	call_wasm_method::<HostFunctions>(&WASM_BINARY.unwrap()[..], "test_return_data");
}

#[test]
fn test_return_option_data() {
	call_wasm_method::<HostFunctions>(&WASM_BINARY.unwrap()[..], "test_return_option_data");
}

#[test]
fn test_set_storage() {
	let mut ext = call_wasm_method::<HostFunctions>(&WASM_BINARY.unwrap()[..], "test_set_storage");
...
fn test_return_value_into_mutable_reference() {
	call_wasm_method::<HostFunctions>(&WASM_BINARY.unwrap()[..], "test_return_value_into_mutable_reference");
}

#[test]
fn test_get_and_return_array() {
	call_wasm_method::<HostFunctions>(&WASM_BINARY.unwrap()[..], "test_get_and_return_array");
}

#[test]
fn test_array_as_mutable_reference() {
	call_wasm_method::<HostFunctions>(&WASM_BINARY.unwrap()[..], "test_array_as_mutable_reference");
}

#[test]
fn test_return_input_public_key() {
	call_wasm_method::<HostFunctions>(&WASM_BINARY.unwrap()[..], "test_return_input_public_key");
}

#[test]
fn host_function_not_found() {
	let err = call_wasm_method_with_result::<()>(&WASM_BINARY.unwrap()[..], "test_return_data").unwrap_err();
...
fn test_invalid_utf8_data_should_return_an_error() {
	call_wasm_method::<HostFunctions>(&WASM_BINARY.unwrap()[..], "test_invalid_utf8_data_should_return_an_error");
}

#[test]
fn test_overwrite_native_function_implementation() {
	call_wasm_method::<HostFunctions>(&WASM_BINARY.unwrap()[..], "test_overwrite_native_function_implementation");
}

#[test]
fn test_u128_i128_as_parameter_and_return_value() {
	call_wasm_method::<HostFunctions>(&WASM_BINARY.unwrap()[..], "test_u128_i128_as_parameter_and_return_value");
}

#[test]
fn test_vec_return_value_memory_is_freed() {
	call_wasm_method::<HostFunctions>(&WASM_BINARY.unwrap()[..], "test_vec_return_value_memory_is_freed");
}

#[test]
fn test_encoded_return_value_memory_is_freed() {
	call_wasm_method::<HostFunctions>(&WASM_BINARY.unwrap()[..], "test_encoded_return_value_memory_is_freed");
}

#[test]
fn test_array_return_value_memory_is_freed() {
	call_wasm_method::<HostFunctions>(&WASM_BINARY.unwrap()[..], "test_array_return_value_memory_is_freed");
}
