...
use sp_runtime_interface_test_wasm::{test_api::HostFunctions, WASM_BINARY};
...
fn call_wasm_method<HF: HostFunctionsT>(binary: &[u8], method: &str) -> TestExternalities {
    ...
    executor
        .call_in_wasm(binary, None, method, &[], &mut ext_ext)
...
#[test]
#[should_panic(expected = "Instantiation: Export ext_test_api_return_input_version_1 not found")]
...
#[test]
#[should_panic(
    expected = "Executes `test_invalid_utf8_data_should_return_an_error`: \
...
fn test_versionining_with_new_host_works() {
    ...
    call_wasm_method::<HostFunctions>(&WASM_BINARY[..], "test_versionning_works");
    ...
    call_wasm_method::<HostFunctions>(&WASM_BINARY_DEPRECATED[..], "test_versionning_works");
}
