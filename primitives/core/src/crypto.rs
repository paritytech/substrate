...
#[cfg(feature = "std")]
pub use sp_ss58::set_default_ss58_version;
pub use sp_ss58::{
	Derive, DeriveJunction, ParseError, PublicError, Ss58AddressFormat, Ss58Codec, DEV_ADDRESS,
	JUNCTION_ID_LEN,
};
#[doc(hidden)]
...
pub trait Pair: CryptoType + Sized + Clone + Send + Sync + 'static {
	...
	fn from_string_with_seed(
		...
		let path = sp_ss58::JUNCTION_REGEX
