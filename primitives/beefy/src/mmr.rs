...
#[derive(Debug, PartialEq, Eq, Clone, Default, Encode, Decode, MaxEncodedLen, TypeInfo)]
...
#[derive(Debug, Default, PartialEq, Eq, Clone, Encode, Decode, MaxEncodedLen, TypeInfo)]
