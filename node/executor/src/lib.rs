...
mod tests {
    ...
    use node_runtime::{
        ...
        GenesisConfig, GrandpaConfig, Header, IndicesConfig, Log, Runtime, SessionConfig,
        StakingConfig, System, SystemConfig, UncheckedExtrinsic,
    };
    use parity_codec::{Decode, Encode, Joiner};
    use primitives::map;
    use primitives::{
        twox_128, Blake2Hasher, ChangesTrieConfiguration, NativeOrEncoded, NeverNativeValue,
    };
    use runtime_io;
    ...
    use wabt;
    use {balances, consensus, contract, indices, session, staking, system, timestamp, treasury};
...
"#;
    ...
    fn deploying_wasm_contract_should_work() {
        ...
        let b = construct_block(
            ...
            vec![
                ...
                CheckedExtrinsic {
                    ...
                    function: Call::Contract(contract::Call::put_code::<Runtime>(
                        10_000,
                        transfer_code,
                    )),
                },
        ...
        runtime_io::with_externalities(&mut t, || {
            ...
            assert_eq!(
                &contract::CodeHashOf::<Runtime>::get(addr).unwrap(),
                &transfer_ch
            );
        });
    }
