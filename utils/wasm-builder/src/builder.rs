...
fn build_project(file_name: PathBuf, project_cargo_toml: PathBuf, default_rustflags: String) {
    ...
    let (wasm_binary, bloaty) =
        crate::wasm_project::create_and_compile(&project_cargo_toml, &default_rustflags, cargo_cmd);
