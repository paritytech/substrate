...
pub type Executor = sc_client::LocalCallExecutor<Backend, NativeExecutor<LocalExecutor>>;
...
pub trait TestClientBuilderExt<B>: Sized {
    ...
    fn build_with_longest_chain(
        ...
        Client<B>,
        sc_client::LongestChain<B, substrate_test_runtime::Block>,
    );
...
pub fn new_light() -> (
    ...
    let local_call_executor =
        sc_client::LocalCallExecutor::new(backend.clone(), executor, sp_core::tasks::executor());
