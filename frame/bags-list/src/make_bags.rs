...
// TODO we can't access currency or currency to weight from this module
// #[cfg(any(feature = "std", feature = "make-bags"))]
// fn existential_weight<T: Config>() -> VoteWeight {
...
pub fn generate_thresholds_module<T: Config>(
	...
	// existential weight TODO can't get existential weight since we don't have currency module.
