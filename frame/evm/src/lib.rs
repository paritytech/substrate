...
decl_storage! {
	trait Store for Module<T: Trait> as EVM {
		Accounts get(fn accounts) config(): map hasher(blake2_64_concat) H160 => Account;
		AccountCodes: map hasher(blake2_64_concat) H160 => Vec<u8>;
		AccountStorages: double_map hasher(blake2_64_concat) H160, hasher(blake2_64_concat) H256 => H256;
	}
}
