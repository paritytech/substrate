...
impl<T: frame_system::Config> WeightInfo for SubstrateWeight<T> {
	...
	fn whitelist_call() -> Weight {
		...
		//  Measured:  `217`
		//  Estimated: `5081`
		// Minimum execution time: 18_982 nanoseconds.
	...
	fn remove_whitelisted_call() -> Weight {
		...
		Weight::from_ref_time(17_994_000)
			.saturating_add(Weight::from_proof_size(5081))
			.saturating_add(T::DbWeight::get().reads(2_u64))
			.saturating_add(T::DbWeight::get().writes(2_u64))
	}
	...
	fn dispatch_whitelisted_call(n: u32, ) -> Weight {
		...
		Weight::from_ref_time(28_876_000)
			.saturating_add(Weight::from_proof_size(8007))
			// Standard Error: 1
			.saturating_add(Weight::from_ref_time(1_146).saturating_mul(n.into()))
	...
	fn dispatch_whitelisted_call_with_preimage(n: u32, ) -> Weight {
		...
		Weight::from_ref_time(22_583_522)
			.saturating_add(Weight::from_proof_size(5081))
			// Standard Error: 5
			.saturating_add(Weight::from_ref_time(1_520).saturating_mul(n.into()))
			.saturating_add(T::DbWeight::get().reads(2_u64))
			.saturating_add(T::DbWeight::get().writes(2_u64))
	}
}
