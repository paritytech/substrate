...
impl<T: crate::Config> WeightInfo for SubstrateWeight<T> {
	...
	fn remark(b: u32, ) -> Weight {
		...
		Weight::from_ref_time(4_190_767)
	...
	fn remark_with_event(b: u32, ) -> Weight {
		...
		Weight::from_ref_time(490_316)
			.saturating_add(Weight::from_proof_size(0))
			// Standard Error: 0
			.saturating_add(Weight::from_ref_time(1_795).saturating_mul(b.into()))
	}
	...
	fn set_heap_pages() -> Weight {
		...
		//  Measured:  `0`
		//  Estimated: `1485`
		// Minimum execution time: 4_974 nanoseconds.
	...
	fn set_storage(i: u32, ) -> Weight {
		...
		Weight::from_ref_time(2_382_000)
			...
			.saturating_add(Weight::from_ref_time(867_265).saturating_mul(i.into()))
	...
	fn kill_storage(i: u32, ) -> Weight {
		...
		Weight::from_ref_time(2_502_000)
			.saturating_add(Weight::from_proof_size(0))
			// Standard Error: 825
			.saturating_add(Weight::from_ref_time(656_039).saturating_mul(i.into()))
			.saturating_add(T::DbWeight::get().writes((1_u64).saturating_mul(i.into())))
	}
	/// Storage: Skipped Metadata (r:0 w:0)
	/// Proof Skipped: Skipped Metadata (max_values: None, max_size: None, mode: Measured)
	...
	fn kill_prefix(p: u32, ) -> Weight {
		...
		Weight::from_ref_time(4_709_000)
			...
			.saturating_add(Weight::from_ref_time(1_376_159).saturating_mul(p.into()))
