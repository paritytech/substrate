...
use frame_support::{
	...
	storage,
	traits::{
		Contains, Get, PalletRuntimeSetup, OnNewAccount, OnKilledAccount, IsDeadAccount, Happened,
...
pub trait Trait: 'static + Eq + Clone {
	...
	///
	/// Expects the `PalletRuntimeSetup` type that is being generated by `construct_runtime!` in the
	/// runtime.
	///
