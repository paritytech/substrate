...
impl<T: frame_system::Config> WeightInfo for SubstrateWeight<T> {
	...
	fn validate_unsigned_and_then_heartbeat(k: u32, e: u32, ) -> Weight {
		...
		//  Measured:  `359 + k * (32 ±0)`
		//  Estimated: `10349672 + k * (64 ±0) + e * (35 ±0)`
		// Minimum execution time: 130_475 nanoseconds.
		Weight::from_ref_time(101_080_075)
			.saturating_add(Weight::from_proof_size(10349672))
			// Standard Error: 415
			.saturating_add(Weight::from_ref_time(35_986).saturating_mul(k.into()))
			// Standard Error: 4_181
			.saturating_add(Weight::from_ref_time(520_915).saturating_mul(e.into()))
			.saturating_add(T::DbWeight::get().reads(4_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
			.saturating_add(Weight::from_proof_size(64).saturating_mul(k.into()))
			.saturating_add(Weight::from_proof_size(35).saturating_mul(e.into()))
	}
}
