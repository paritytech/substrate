...
fn heartbeat<T: Trait>() -> crate::Heartbeat<T::BlockNumber> {
	crate::Heartbeat::<T::BlockNumber> {
		...
		session_index : 1u32 as SessionIndex,
		authority_index : 1u32 as AuthIndex,
	...
	<<T as Trait>::AuthorityId as RuntimeAppPublic>::Signature : core::default::Default,
{
	...
	{
		let authoring_key = account::<T::AuthorityId>("Kwak", 1, 2_718_281);
		Module::<T>::initialize_keys(&[authoring_key]);
