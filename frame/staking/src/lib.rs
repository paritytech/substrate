...
#[derive(PartialEq, Eq, Copy, Clone, Encode, Decode, MaxEncodedLen, RuntimeDebug, TypeInfo)]
...
#[derive(PartialEq, Eq, Clone, Encode, Decode, MaxEncodedLen, RuntimeDebug, TypeInfo, Default)]
...
#[derive(PartialEqNoBound, EqNoBound, Clone, Encode, Decode, MaxEncodedLen, RuntimeDebugNoBound, TypeInfo)]
#[codec(mel_bound())]
#[scale_info(skip_type_params(T))]
