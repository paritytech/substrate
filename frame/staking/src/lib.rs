...
//! validator as well as its nominators. Only the [`Config::MaxNominatorRewardedPerPage`]
...
//! [`Config::MaxNominatorRewardedPerPage`] nominators. The distribution of nominators across pages
//! are unsorted and depends on the election result provided by [`Config::ElectionProvider`].
//!
