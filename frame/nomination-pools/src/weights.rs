...
impl<T: frame_system::Config> WeightInfo for SubstrateWeight<T> {
	...
	fn nominate(n: u32, ) -> Weight {
		(49_442_000 as Weight)
			...
			.saturating_add((2_217_000 as Weight).saturating_mul(n as Weight))
