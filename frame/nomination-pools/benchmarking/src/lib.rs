...
use frame_support::{assert_ok, ensure, instances::Instance1, traits::Get};
...
pub trait Config:
	pallet_nomination_pools::Config + pallet_staking::Config + pallet_bags_list::Config<Instance1>
{
}
