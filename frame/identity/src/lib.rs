...
use sp_runtime::traits::{AppendZerosInput, StaticLookup, Zero};
...
mod weight_for {
    ...
    pub(crate) fn add_registrar<T: Trait>(registrars: Weight) -> Weight {
    ...
    pub(crate) fn set_identity<T: Trait>(judgements: Weight, extra_fields: Weight) -> Weight {
        T::DbWeight::get().reads_writes(1, 1)
			+ 51_000_000 // constant
    ...
    pub(crate) fn set_subs<T: Trait>(old_subs: Weight, subs: Weight) -> Weight {
    ...
    pub(crate) fn request_judgement<T: Trait>(judgements: Weight, extra_fields: Weight) -> Weight {
    ...
    pub(crate) fn cancel_request<T: Trait>(judgements: Weight, extra_fields: Weight) -> Weight {
        T::DbWeight::get().reads_writes(1, 1)
			+ 41_000_000 // constant
    ...
    pub(crate) fn provide_judgement<T: Trait>(judgements: Weight, extra_fields: Weight) -> Weight {
        T::DbWeight::get().reads_writes(2, 1)
			+ 41_000_000 // constant
			+ 300_000 * judgements // R
			+ 1_700_000 * extra_fields // X
...
mod tests {
    ...
    fn registration_should_work() {
        new_test_ext().execute_with(|| {
            ...
            assert_noop!(
                Identity::clear_identity(Origin::signed(10)),
                Error::<Test>::NotNamed
            );
        });
    }
    ...
    fn killing_slashing_should_work() {
        new_test_ext().execute_with(|| {
            ...
            assert_eq!(Balances::free_balance(10), 90);
            assert_noop!(
                Identity::kill_identity(Origin::signed(2), 10),
                Error::<Test>::NotNamed
            );
        });
    }
