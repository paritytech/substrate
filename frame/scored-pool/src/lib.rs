...
use sp_runtime::{
	traits::{EnsureOrigin, RuntimeArithmetic, MaybeSerializeDeserialize, Zero, StaticLookup},
};
...
pub trait Trait<I=DefaultInstance>: frame_system::Trait {
	...
	type Score:
		RuntimeArithmetic + Clone + Copy + Default + FullCodec + MaybeSerializeDeserialize + Debug;
