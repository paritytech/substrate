...
mod tests {
	...
	create_test!(seal_terminate_per_code_kb);
	create_test!(seal_restore_to);
	create_test!(seal_restore_to_per_code_kb_delta);
	...
	create_test!(seal_call_per_code_transfer_input_output_kb);
	create_test!(seal_instantiate);
	create_test!(seal_instantiate_per_code_input_output_salt_kb);
