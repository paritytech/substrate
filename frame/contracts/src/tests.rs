		...
		assert_eq!(
			...
			vec![
				EventRecord {
					...
					event: RuntimeEvent::System(frame_system::PalletEvent::NewAccount {
						account: addr.clone()
					}),
					topics: vec![],
				},
				EventRecord {
					phase: Phase::Initialization,
					event: RuntimeEvent::Balances(pallet_balances::PalletEvent::Endowed {
						account: addr.clone(),
				...
				EventRecord {
					phase: Phase::Initialization,
					event: RuntimeEvent::Balances(pallet_balances::PalletEvent::Transfer {
						from: ALICE,
						to: addr.clone(),
						amount: min_balance,
					}),
				...
				EventRecord {
					phase: Phase::Initialization,
					event: RuntimeEvent::Balances(pallet_balances::PalletEvent::Reserved {
						who: addr.clone(),
						amount: min_balance,
					}),
					topics: vec![],
				...
				EventRecord {
					phase: Phase::Initialization,
					event: RuntimeEvent::Contracts(crate::PalletEvent::ContractEmitted {
						contract: addr.clone(),
						data: vec![1, 2, 3, 4]
					}),
					topics: vec![],
				...
				EventRecord {
					phase: Phase::Initialization,
					event: RuntimeEvent::Contracts(crate::PalletEvent::Instantiated {
						deployer: ALICE,
						contract: addr.clone()
					}),
					topics: vec![],
	...
	ExtBuilder::default().existential_deposit(500).build().execute_with(|| {
		...
		assert_eq!(
			...
			vec![
				EventRecord {
					phase: Phase::Initialization,
					event: RuntimeEvent::Balances(pallet_balances::PalletEvent::Slashed {
						who: addr.clone(),
						amount: 90,
					}),
					topics: vec![],
	...
	ExtBuilder::default().existential_deposit(1_000).build().execute_with(|| {
		...
		pretty_assertions::assert_eq!(
			...
			vec![
				...
				EventRecord {
					phase: Phase::Initialization,
					event: RuntimeEvent::Contracts(crate::PalletEvent::Terminated {
						contract: addr.clone(),
						beneficiary: DJANGO
					}),
					topics: vec![],
				...
				EventRecord {
					phase: Phase::Initialization,
					event: RuntimeEvent::System(frame_system::PalletEvent::KilledAccount {
						account: addr.clone()
					}),
					topics: vec![],
				},
	...
	ExtBuilder::default().existential_deposit(100).build().execute_with(|| {
		...
		assert_eq!(
			...
			vec![
				...
				EventRecord {
					phase: Phase::Initialization,
					event: RuntimeEvent::Contracts(crate::PalletEvent::CodeStored { code_hash }),
					topics: vec![],
				},
			]
		);
	...
	ExtBuilder::default().existential_deposit(100).build().execute_with(|| {
		...
		assert_eq!(
			...
			vec![
				...
				EventRecord {
					phase: Phase::Initialization,
					event: RuntimeEvent::Balances(pallet_balances::PalletEvent::Unreserved {
						who: ALICE,
						amount: 240,
					}),
					topics: vec![],
				...
				EventRecord {
					phase: Phase::Initialization,
					event: RuntimeEvent::Contracts(crate::PalletEvent::CodeRemoved { code_hash }),
					topics: vec![],
				},
			]
		);
