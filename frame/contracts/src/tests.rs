...
pub mod test_utils {
    ...
    use crate::{
        ...
        storage::Storage,
        CodeHash, ContractInfoOf, Module as Contracts,
    };
        ...
        .execute_with(|| {
            ...
            assert_eq!(
                ...
                vec![
                    ...
                    EventRecord {
                        phase: Phase::Initialization,
                        event: Event::pallet_contracts(RawEvent::ContractEmitted(
                            addr.clone(),
                            vec![1, 2, 3, 4]
                        )),
                        topics: vec![],
            ...
            if !test_code_evicted {
                ...
                events.extend(
                    [
                        ...
                        EventRecord {
                            phase: Phase::Initialization,
                            event: Event::pallet_contracts(RawEvent::Instantiated(
                                ALICE,
                                addr_dummy.clone(),
                            )),
                            topics: vec![],
            ...
            if test_different_storage || test_restore_to_with_dirty_storage || test_code_evicted {
                    ...
                    (_, true, false) => {
                        ...
                        assert_eq!(
                            ...
                            vec![
                                ...
                                EventRecord {
                                    phase: Phase::Initialization,
                                    event: Event::pallet_contracts(RawEvent::CodeStored(
                ...
                assert_eq!(
                    ...
                    vec![
                        EventRecord {
                            phase: Phase::Initialization,
                            event: Event::pallet_contracts(RawEvent::CodeRemoved(
                                restoration_code_hash
                            )),
                            topics: vec![],
                        },
                        ...
                        EventRecord {
                            phase: Phase::Initialization,
                            event: Event::pallet_contracts(RawEvent::Restored(
                                addr_django,
                                addr_bob,
        ...
        .execute_with(|| {
            ...
            pretty_assertions::assert_eq!(
                ...
                vec![
                    ...
                    EventRecord {
                        phase: Phase::Initialization,
                        event: Event::pallet_contracts(RawEvent::Terminated(addr.clone(), DJANGO)),
                        topics: vec![],
                    },
                ]
            );
    ...
    ExtBuilder::default()
        ...
        .execute_with(|| {
            ...
            for (n, (hash_fn, expected_size)) in test_cases.iter().enumerate() {
                ...
                let result = <Module<Test>>::bare_call(ALICE, addr.clone(), 0, GAS_LIMIT, params)
                    .exec_result
                    .unwrap();
