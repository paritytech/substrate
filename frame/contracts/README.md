...
This module extends accounts based on the `fungible` traits to have smart-contract functionality. It can
be used with other modules that implement accounts based on `fungible`. These "smart-contract accounts"
