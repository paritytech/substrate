...
mod tests {
    ...
    fn should_encode_decode_correctly_if_no_compact() {
        ...
        let cases = vec![
            ...
            Test::Hash(hex(
                "c3e7ba6b511162fead58f2c8b5764ce869ed1118011ac37392522ed16720bbcd",
            )),
            Test::Data("".into()),
        ...
        assert_eq!(
            ...
            cases
                .into_iter()
                .map(Result::<_, codec::Error>::Ok)
                .collect::<Vec<_>>()
        );
        // check encoding correctness
        assert_eq!(
            &encoded[0],
            &hex_literal::hex!("00343048656c6c6f20576f726c6421")
        );
        assert_eq!(
            encoded[1].as_slice(),
    ...
    fn should_return_the_hash_correctly() {
        ...
        assert_eq!(
            a,
            hex("a9c321be8c24ba4dc2bd73f5300bde67dc57228ab8b68b607bb4c39c5374fac9")
        );
        assert_eq!(
            b,
            hex("c3e7ba6b511162fead58f2c8b5764ce869ed1118011ac37392522ed16720bbcd")
