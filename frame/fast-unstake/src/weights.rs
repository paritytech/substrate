...
//! DATE: 2023-01-15, STEPS: `10`, REPEAT: 10, LOW RANGE: `[]`, HIGH RANGE: `[]`
...
impl<T: frame_system::Config> WeightInfo for SubstrateWeight<T> {
	...
	fn on_idle_unstake(b: u32, ) -> Weight {
		// Minimum execution time: 1_382_000 nanoseconds.
		Weight::from_ref_time(549_762_337)
			// Standard Error: 4_044_144
			.saturating_add(Weight::from_ref_time(728_843_722).saturating_mul(b.into()))
	...
	/// The range of component `b` is `[1, 64]`.
	fn on_idle_check(v: u32, b: u32, ) -> Weight {
		// Minimum execution time: 8_652_000 nanoseconds.
		Weight::from_ref_time(9_129_000_000)
			// Standard Error: 185_258_368
			.saturating_add(Weight::from_ref_time(1_958_356_246).saturating_mul(v.into()))
			// Standard Error: 739_696_655
			.saturating_add(Weight::from_ref_time(7_433_498_155).saturating_mul(b.into()))
	...
	fn register_fast_unstake() -> Weight {
		// Minimum execution time: 1_939_000 nanoseconds.
		Weight::from_ref_time(2_072_000_000)
