...
fn award_and_claim_bounty_works() {
	new_test_ext().execute_with(|| {
		...
		<Treasury as Hooks<u64>>::on_initialize(5);
...
fn expire_and_unassign() {
	new_test_ext().execute_with(|| {
		...
		<Treasury as Hooks<u64>>::on_initialize(22);
		...
		<Treasury as Hooks<u64>>::on_initialize(23);
...
fn extend_expiry() {
	new_test_ext().execute_with(|| {
		...
		<Treasury as Hooks<u64>>::on_initialize(10);
		...
		<Treasury as Hooks<u64>>::on_initialize(25);
...
fn unassign_curator_self() {
	new_test_ext().execute_with(|| {
		...
		<Treasury as Hooks<u64>>::on_initialize(8);
...
fn accept_curator_handles_different_deposit_calculations() {
	...
	new_test_ext().execute_with(|| {
		...
		<Treasury as Hooks<u64>>::on_initialize(6);
...
fn approve_bounty_works_second_instance() {
	new_test_ext().execute_with(|| {
		...
		<Treasury as Hooks<u64>>::on_initialize(2);
		<Treasury1 as Hooks<u64>>::on_initialize(2);
