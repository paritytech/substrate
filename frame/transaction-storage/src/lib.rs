...
pub mod pallet {
	...
	impl<T: Config> Pallet<T> {
		...
		pub fn renew(
			origin: OriginFor<T>,
			block: frame_system::BlockNumberOf<T>,
			index: u32,
	...
	pub(super) type ChunkCount<T: Config> =
		StorageMap<_, Blake2_128Concat, frame_system::BlockNumberOf<T>, u32, ValueQuery>;
	...
	pub struct GenesisConfig<T: Config> {
		...
		pub storage_period: frame_system::BlockNumberOf<T>,
	}
