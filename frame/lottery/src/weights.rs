...
impl<T: frame_system::Config> WeightInfo for SubstrateWeight<T> {
	...
	fn buy_ticket() -> Weight {
		(38_236 as Weight).saturating_mul(WEIGHT_PER_NANOS)
			.saturating_add(T::DbWeight::get().reads(6 as Weight))
			.saturating_add(T::DbWeight::get().writes(4 as Weight))
	}
	// Storage: Lottery CallIndices (r:0 w:1)
	fn set_calls(n: u32, ) -> Weight {
		(8_991 as Weight).saturating_mul(WEIGHT_PER_NANOS)
			// Standard Error: 6 NS
			.saturating_add((294 as Weight).saturating_mul(WEIGHT_PER_NANOS).saturating_mul(n as Weight))
	...
	// Storage: System Account (r:1 w:1)
	fn start_lottery() -> Weight {
		(32_071 as Weight).saturating_mul(WEIGHT_PER_NANOS)
			.saturating_add(T::DbWeight::get().reads(3 as Weight))
			.saturating_add(T::DbWeight::get().writes(3 as Weight))
	}
	// Storage: Lottery Lottery (r:1 w:1)
	fn stop_repeat() -> Weight {
		(3_782 as Weight).saturating_mul(WEIGHT_PER_NANOS)
	...
	fn on_initialize_end() -> Weight {
		(50_981 as Weight).saturating_mul(WEIGHT_PER_NANOS)
			.saturating_add(T::DbWeight::get().reads(6 as Weight))
			.saturating_add(T::DbWeight::get().writes(4 as Weight))
	}
	// Storage: RandomnessCollectiveFlip RandomMaterial (r:1 w:0)
	...
	// Storage: Lottery LotteryIndex (r:1 w:1)
	fn on_initialize_repeat() -> Weight {
		(55_169 as Weight).saturating_mul(WEIGHT_PER_NANOS)
