...
impl<T: frame_system::Config> WeightInfo for SubstrateWeight<T> {
    ...
    fn external_propose_majority() -> Weight {
        (4_544_000 as Weight).saturating_add(T::DbWeight::get().writes(1 as Weight))
    }
    fn external_propose_default() -> Weight {
        (4_608_000 as Weight).saturating_add(T::DbWeight::get().writes(1 as Weight))
    }
    fn fast_track() -> Weight {
    ...
    fn cancel_referendum() -> Weight {
        (23_670_000 as Weight).saturating_add(T::DbWeight::get().writes(1 as Weight))
    }
    fn cancel_queued(r: u32) -> Weight {
    ...
    fn clear_public_proposals() -> Weight {
        (4_404_000 as Weight).saturating_add(T::DbWeight::get().writes(1 as Weight))
    }
    fn note_preimage(b: u32) -> Weight {
...
impl WeightInfo for () {
    ...
    fn external_propose_majority() -> Weight {
        (4_544_000 as Weight).saturating_add(RocksDbWeight::get().writes(1 as Weight))
    }
    fn external_propose_default() -> Weight {
        (4_608_000 as Weight).saturating_add(RocksDbWeight::get().writes(1 as Weight))
    }
    fn fast_track() -> Weight {
        (38_876_000 as Weight)
            .saturating_add(RocksDbWeight::get().reads(2 as Weight))
    ...
    fn cancel_referendum() -> Weight {
        (23_670_000 as Weight).saturating_add(RocksDbWeight::get().writes(1 as Weight))
    }
    fn cancel_queued(r: u32) -> Weight {
        (43_247_000 as Weight)
            .saturating_add((4_578_000 as Weight).saturating_mul(r as Weight))
    ...
    fn clear_public_proposals() -> Weight {
        (4_404_000 as Weight).saturating_add(RocksDbWeight::get().writes(1 as Weight))
    }
    fn note_preimage(b: u32) -> Weight {
        (60_073_000 as Weight)
            .saturating_add((4_000 as Weight).saturating_mul(b as Weight))
