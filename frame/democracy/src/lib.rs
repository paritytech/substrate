...
pub use types::{Delegations, ProxyState, ReferendumInfo, ReferendumStatus, Tally, UnvoteScope};
...
mod weight_for {
    ...
    pub fn proxy_delegate<T: Trait>(votes: Weight) -> Weight {
        T::DbWeight::get()
            .reads_writes(votes.saturating_add(5), votes.saturating_add(4))
    ...
    pub fn proxy_undelegate<T: Trait>(votes: Weight) -> Weight {
        T::DbWeight::get()
            .reads_writes(votes.saturating_add(3), votes.saturating_add(2))
