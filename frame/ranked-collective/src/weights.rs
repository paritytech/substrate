...
// --steps=50
// --repeat=20
// --pallet=pallet-ranked-collective
// --extrinsic=*
// --execution=wasm
// --heap-pages=4096
...
impl<T: frame_system::Config> WeightInfo for SubstrateWeight<T> {
	...
	// Storage: RankedCollective MemberByIndex (r:0 w:1)
	fn add_member() -> Weight {
	...
	// Storage: RankedCollective MemberCount (r:1 w:1)
	// Storage: RankedCollective MemberByIndex (r:1 w:2)
	fn remove_member() -> Weight {
	...
	fn cleanup_poll(n: u32, ) -> Weight {
		(7_800_000 as Weight)
			...
			.saturating_add((860_000 as Weight).saturating_mul(n as Weight))
