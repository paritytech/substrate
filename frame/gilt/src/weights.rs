...
impl<T: frame_system::Config> WeightInfo for SubstrateWeight<T> {
	...
	fn place_bid(l: u32, ) -> Weight {
		Weight::from_ref_time(41_693_000 as u64)
			// Standard Error: 131
			.saturating_add(Weight::from_ref_time(49_156 as u64).saturating_mul(l as u64))
	...
	// Storage: Gilt QueueTotals (r:1 w:1)
	fn place_bid_max() -> Weight {
		Weight::from_ref_time(84_985_000 as u64)
			.saturating_add(T::DbWeight::get().reads(2 as u64))
			.saturating_add(T::DbWeight::get().writes(2 as u64))
	}
	// Storage: Gilt Queues (r:1 w:1)
	...
	fn retract_bid(l: u32, ) -> Weight {
		Weight::from_ref_time(43_600_000 as u64)
			// Standard Error: 97
			.saturating_add(Weight::from_ref_time(36_606 as u64).saturating_mul(l as u64))
			.saturating_add(T::DbWeight::get().reads(2 as u64))
			.saturating_add(T::DbWeight::get().writes(2 as u64))
	}
	// Storage: Gilt ActiveTotal (r:1 w:1)
	fn set_target() -> Weight {
		Weight::from_ref_time(7_158_000 as u64)
	...
	fn pursue_target_noop() -> Weight {
		Weight::from_ref_time(3_191_000 as u64)
			.saturating_add(T::DbWeight::get().reads(1 as u64))
	}
	// Storage: Gilt ActiveTotal (r:1 w:1)
	// Storage: Gilt QueueTotals (r:1 w:1)
	...
	fn pursue_target_per_item(b: u32, ) -> Weight {
		Weight::from_ref_time(32_570_000 as u64)
			...
			.saturating_add(Weight::from_ref_time(4_151_789 as u64).saturating_mul(b as u64))
			.saturating_add(T::DbWeight::get().reads(2 as u64))
			.saturating_add(T::DbWeight::get().writes(2 as u64))
	...
	fn pursue_target_per_queue(q: u32, ) -> Weight {
		Weight::from_ref_time(32_237_000 as u64)
			...
			.saturating_add(Weight::from_ref_time(7_040_733 as u64).saturating_mul(q as u64))
			.saturating_add(T::DbWeight::get().reads(2 as u64))
