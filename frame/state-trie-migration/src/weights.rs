...
impl<T: frame_system::Config> WeightInfo for SubstrateWeight<T> {
	...
	fn continue_migrate() -> Weight {
		...
		Weight::from_ref_time(16_248_000)
	...
	fn migrate_custom_top_fail() -> Weight {
		...
		Weight::from_ref_time(27_421_000)
	...
	fn migrate_custom_child_success() -> Weight {
		...
		//  Measured:  `0`
		//  Estimated: `0`
		// Minimum execution time: 10_703 nanoseconds.
	...
	fn process_top_key(v: u32, ) -> Weight {
		...
		// Minimum execution time: 5_857 nanoseconds.
		Weight::from_ref_time(6_017_000)
			.saturating_add(Weight::from_proof_size(3690))
			// Standard Error: 1
			.saturating_add(Weight::from_ref_time(1_246).saturating_mul(v.into()))
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
