...
use sp_runtime::traits::{Member, RuntimeArithmetic, Zero, StaticLookup};
use frame_system::{self as system, ensure_signed};
...
pub trait Trait: frame_system::Trait {
	...
	type Balance: Member + Parameter + RuntimeArithmetic + Default + Copy;

	/// The arithmetic type of asset identifier.
	type AssetId: Parameter + RuntimeArithmetic + Default + Copy;
}
