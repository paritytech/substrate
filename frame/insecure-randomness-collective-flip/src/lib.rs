...
fn block_number_to_index<T: Config>(block_number: frame_system::BlockNumberOf<T>) -> usize {
...
impl<T: Config> Randomness<T::Hash, frame_system::BlockNumberOf<T>> for Pallet<T> {
