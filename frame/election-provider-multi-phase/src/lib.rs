...
pub mod pallet {
	...
	pub trait Config: frame_system::Config + SendTransactionTypes<Call<Self>> {
		...
		#[pallet::constant]
		type UnsignedPhase: Get<frame_system::BlockNumberOf<Self>>;
		/// Duration of the signed phase.
		#[pallet::constant]
		type SignedPhase: Get<frame_system::BlockNumberOf<Self>>;
		...
		#[pallet::constant]
		type OffchainRepeat: Get<frame_system::BlockNumberOf<Self>>;
