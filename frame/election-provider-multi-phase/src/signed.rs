...
impl<T: Config> Pallet<T> {
	...
	pub fn finalize_signed_phase_accept_solution(
		...
		// emit reward event
		Self::deposit_event(crate::PalletEvent::Rewarded { account: who.clone(), value: reward });
	...
	pub fn finalize_signed_phase_reject_solution(who: &T::AccountId, deposit: BalanceOf<T>) {
		Self::deposit_event(crate::PalletEvent::Slashed { account: who.clone(), value: deposit });
