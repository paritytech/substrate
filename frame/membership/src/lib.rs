...
pub mod pallet {
	...
	impl<T: Config<I>, I: 'static> Pallet<T, I> {
		...
		pub fn add_member(origin: OriginFor<T>, who: <T::Lookup as StaticLookup>::Source) -> DispatchResult {
		...
		#[pallet::weight(50_000_000)]
		pub fn change_key(origin: OriginFor<T>, new: <T::Lookup as StaticLookup>::Source) -> DispatchResult {
		...
		#[pallet::weight(50_000_000)]
		pub fn set_prime(origin: OriginFor<T>, who: <T::Lookup as StaticLookup>::Source) -> DispatchResult {
