...
use frame_support::{
	...
	traits::{
		fungible, fungible::Lockable, Currency, ExistenceRequirement, Get, VestingSchedule,
		WithdrawReasons,
	},
	weights::Weight,
};
...
type MaxLocksOf<T> = <<T as Config>::Currency as fungible::Lockable<
	<T as frame_system::Config>::AccountId,
>>::MaxLocks;
type AccountIdLookupOf<T> = <<T as frame_system::Config>::Lookup as StaticLookup>::Source;

const VESTING_ID: fungible::LockIdentifier = *b"vesting ";
...
pub mod pallet {
	...
	pub trait Config: frame_system::Config {
		...
		/// The currency trait.
		type Currency: fungible::Lockable<Self::AccountId>;
