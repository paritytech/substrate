...
fn add_vesting_schedules<T: Config>(
	...
	System::<T>::set_block_number(frame_system::pallet_prelude::BlockNumberFor::<T>::zero());
...
benchmarks! {
	vest_locked {
		...
		assert_eq!(System::<T>::block_number(), frame_system::pallet_prelude::BlockNumberFor::<T>::zero());
		assert_eq!(
