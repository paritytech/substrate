...
mod tests {
    ...
    fn swap_well_known_node_works() {
        new_test_ext().execute_with(|| {
            ...
            AdditionalConnections::insert(test_node(20), BTreeSet::from_iter(vec![test_node(15)]));
            assert_ok!(NodeAuthorization::swap_well_known_node(
                Origin::signed(3),
                test_node(20),
                test_node(5)
    ...
    fn claim_node_works() {
        new_test_ext().execute_with(|| {
            ...
            assert_ok!(NodeAuthorization::claim_node(
                Origin::signed(15),
                test_node(15)
            ));
            assert_eq!(Owners::<Test>::get(test_node(15)), 15);
    ...
    fn remove_claim_works() {
        new_test_ext().execute_with(|| {
            ...
            AdditionalConnections::insert(test_node(15), BTreeSet::from_iter(vec![test_node(20)]));
            assert_ok!(NodeAuthorization::remove_claim(
                Origin::signed(15),
                test_node(15)
            ));
