...
// use sp_consensus_poc::{AllowedSlots, BabeEpochConfiguration, Slot};
...
// 			c: (0, 4),
// 			allowed_slots: sp_consensus_poc::AllowedSlots::PrimarySlots,
// 		};
//
...
//
// 		let consensus_log = sp_consensus_poc::ConsensusLog::NextConfigData(
// 			NextConfigDescriptor::V1 {
// 				c: next_next_config.c,
// 				allowed_slots: next_next_config.allowed_slots,
// 			}
