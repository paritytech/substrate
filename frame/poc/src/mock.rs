...
// use sp_consensus_poc::{AuthorityId, AuthorityPair, Slot};
...
// 	authority_index: sp_consensus_poc::AuthorityIndex,
// 	slot: sp_consensus_poc::Slot,
// 	vrf_output: VRFOutput,
// 	vrf_proof: VRFProof,
// ) -> Digest {
// 	let digest_data = sp_consensus_poc::digests::PreDigest::Primary(
// 		sp_consensus_poc::digests::PrimaryPreDigest {
// 			authority_index,
// 			slot,
// 			vrf_output,
// 			vrf_proof,
// 		}
// 	);
// 	let log = DigestItem::PreRuntime(sp_consensus_poc::BABE_ENGINE_ID, digest_data.encode());
// 	Digest { logs: vec![log] }
// }
//
...
// 	slot: sp_consensus_poc::Slot,
// ) -> Digest {
// 	let digest_data = sp_consensus_poc::digests::PreDigest::SecondaryPlain(
// 		sp_consensus_poc::digests::SecondaryPlainPreDigest {
// 			authority_index,
// 			slot,
// 		}
// 	);
...
// 	vrf_proof: VRFProof,
// ) -> Digest {
// 	let digest_data = sp_consensus_poc::digests::PreDigest::SecondaryVRF(
// 		sp_consensus_poc::digests::SecondaryVRFPreDigest {
// 			authority_index,
// 			slot,
// 			vrf_output,
// 			vrf_proof,
