...
decl_storage! {
	...
	trait Store for Module<T: Trait> as Example {
		...
		// e.g. Foo: u32;
		// e.g. pub Bar get(fn bar): map hasher(blake2_64_concat) T::AccountId => Vec<(T::Balance, u64)>;
		//
		...
		Bar get(fn bar) config(): map hasher(blake2_64_concat) T::AccountId => T::Balance;
