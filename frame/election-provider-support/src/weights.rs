...
//! DATE: 2022-03-31, STEPS: `1`, REPEAT: 1, LOW RANGE: `[]`, HIGH RANGE: `[]`
...
impl<T: frame_system::Config> WeightInfo for SubstrateWeight<T> {
	...
	fn phragmen(v: u32, t: u32, _d: u32, ) -> Weight {
		(0 as Weight)
			// Standard Error: 17_929_000
			.saturating_add((71_334_000 as Weight).saturating_mul(v as Weight))
			// Standard Error: 35_858_000
			.saturating_add((123_635_000 as Weight).saturating_mul(t as Weight))
	...
	// Storage: Staking ValidatorCount (r:1 w:0)
	fn phragmms(v: u32, t: u32, d: u32, ) -> Weight {
		(100_042_364_000 as Weight)
			// Standard Error: 9_727_000
			.saturating_add((25_062_000 as Weight).saturating_mul(t as Weight))
			// Standard Error: 442_153_000
			.saturating_add((123_727_000 as Weight).saturating_mul(d as Weight))
			.saturating_add(T::DbWeight::get().reads(205 as Weight))
			.saturating_add(T::DbWeight::get().reads((4 as Weight).saturating_mul(v as Weight)))
			.saturating_add(T::DbWeight::get().reads((5 as Weight).saturating_mul(t as Weight)))
	}
