...
pub mod pallet {
	...
	impl<T: Config<I>, I: 'static> Pallet<T, I> {
		...
		fn vote(
			...
			<Voting<T, I>>::insert(&proposal, Some(voting));
	...
	pub struct GenesisConfig<T: Config<I>, I: 'static = ()>{
		...
		// TODO :: Uglly fix, have to recheck
		_inner: sp_std::marker::PhantomData<(T, I)>,
	}
...
mod tests {
	...
	frame_support::construct_runtime!(
			...
			UncheckedExtrinsic = UncheckedExtrinsic
		{
			...
			// Collective: collective::<Instance1>::{Module, Call, Event<T>, Config<T>},
