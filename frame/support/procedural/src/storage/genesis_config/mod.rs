...
fn decl_genesis_config_and_impl_default(
	...
	quote!(
		...
		#serde_bug_bound
		pub struct RuntimeGenesisConfig #genesis_struct_decl #genesis_where_clause {
			#( #config_fields )*
		}

		#[cfg(feature = "std")]
		impl #genesis_impl Default for RuntimeGenesisConfig #genesis_struct #genesis_where_clause {
			fn default() -> Self {
...
fn impl_build_storage(
	...
	quote! {
		#[cfg(feature = "std")]
		impl #genesis_impl RuntimeGenesisConfig #genesis_struct #genesis_where_clause {
		...
		#[cfg(feature = "std")]
		impl #build_storage_impl #build_storage_impl_trait for RuntimeGenesisConfig #genesis_struct
			#where_clause
		{
