pub mod interface {
        ...
        View: sp_api::Encode + frame_support::interface::View,
    {
        ...
        > {
            ...
            < Self as Interface < _ , _ > > :: __runtime_api_internal_call_api_at (self , __runtime_api_at_param__ , self :: sp_api_hidden_includes_DECL_RUNTIME_APIS :: sp_api :: ExecutionContext :: OffchainCall (None) , __runtime_api_impl_params_encoded__ , & (| version | { "Interface_view" })) . and_then (| r | std :: result :: Result :: map_err (< ViewResult < Vec < u8 > > as self :: sp_api_hidden_includes_DECL_RUNTIME_APIS :: sp_api :: Decode > :: decode (& mut & r [..]) , | err | self :: sp_api_hidden_includes_DECL_RUNTIME_APIS :: sp_api :: ApiError :: FailedToDecodeReturnValue { function : "Interface_view" , error : err , }))
        }
        ...
        > {
            let __runtime_api_impl_params_encoded__ =
                self::sp_api_hidden_includes_DECL_RUNTIME_APIS::sp_api::Encode::encode(&(&view));
            < Self as Interface < _ , _ > > :: __runtime_api_internal_call_api_at (self , __runtime_api_at_param__ , context , __runtime_api_impl_params_encoded__ , & (| version | { "Interface_view" })) . and_then (| r | std :: result :: Result :: map_err (< ViewResult < Vec < u8 > > as self :: sp_api_hidden_includes_DECL_RUNTIME_APIS :: sp_api :: Decode > :: decode (& mut & r [..]) , | err | self :: sp_api_hidden_includes_DECL_RUNTIME_APIS :: sp_api :: ApiError :: FailedToDecodeReturnValue { function : "Interface_view" , error : err , }))
        }
        /// !!INTERNAL USE ONLY!!
        #[doc(hidden)]
    ...
    mod tests {
        ...
        #[automatically_derived]
        impl ::core::cmp::PartialOrd for Runtime {
            #[inline]
            fn partial_cmp(
                &self,
                other: &Runtime,
        ...
        #[automatically_derived]
        impl ::core::cmp::Ord for Runtime {
            #[inline]
            fn cmp(&self, other: &Runtime) -> ::core::cmp::Ordering {
                ...
                fn decode<__CodecInputEdqy: ::codec::Input>(
                    ...
                    match __codec_input_edqy.read_byte().map_err(|e| {
                        ...
                        __codec_x_edqy if __codec_x_edqy == 20u8 as ::core::primitive::u8 => {
                            ::core::result::Result::Ok(Call::Pip20({
                                let __codec_res_edqy =
                                    <int_123::Call<Runtime> as ::codec::Decode>::decode(
                                        __codec_input_edqy,
                                    );
                                match __codec_res_edqy {
                                    ::core::result::Result::Err(e) => {
                                        return ::core::result::Result::Err(
                                            e.chain("Could not decode `Call::Pip20.0`"),
                                        )
                                    }
        ...
        pub mod int_123 {
            ...
            struct SelectCurrency<Runtime>(frame_support::sp_std::marker::PhantomData<Runtime>);
            impl<Runtime> SelectCurrency<Runtime> {
                pub fn new() -> Self {
                    SelectCurrency(Default::default())
                }
            }
            impl<Runtime: Pip20> frame_support::interface::Selector for SelectCurrency<Runtime> {
                type Selected = Runtime::Currency;
                fn select(&self, from: sp_core::H256) -> SelectorResult<Self::Selected> {
                    Runtime::select_currency(from)
                }
            }
            struct RestrictedCurrency<Runtime>(frame_support::sp_std::marker::PhantomData<Runtime>);
            ...
            impl<Runtime: Pip20> frame_support::interface::Selector for RestrictedCurrency<Runtime> {
                type Selected = Runtime::Currency;
                fn select(&self, from: sp_core::H256) -> SelectorResult<Self::Selected> {
                    Runtime::select_restricted_currency(from)
                }
            }
            struct SelectAccount<Runtime>(frame_support::sp_std::marker::PhantomData<Runtime>);
            impl<Runtime> SelectAccount<Runtime> {
                pub fn new() -> Self {
                    SelectAccount(Default::default())
                }
            }
            impl<Runtime: Pip20> frame_support::interface::Selector for SelectAccount<Runtime> {
                type Selected = Runtime::AccountId;
                fn select(&self, from: sp_core::H256) -> SelectorResult<Self::Selected> {
                    Runtime::select_account(from)
                }
            }
            struct SelectOrigin<Runtime>(frame_support::sp_std::marker::PhantomData<Runtime>);
            impl<Runtime> SelectOrigin<Runtime> {
                pub fn new() -> Self {
                    SelectOrigin(Default::default())
                }
            }
            impl<Runtime: Pip20> frame_support::interface::Selector for SelectOrigin<Runtime> {
                type Selected = <Runtime as frame_support::interface::Core>::RuntimeOrigin;
                fn select(&self, from: sp_core::H256) -> SelectorResult<Self::Selected> {
                    Runtime::select_origin(from)
                }
            }
            struct DefaultSelector<Runtime>(frame_support::sp_std::marker::PhantomData<Runtime>);
            ...
            const _: () = {
                impl<Runtime: Pip20> core::fmt::Debug for View<Runtime> {
                    fn fmt(&self, fmt: &mut core::fmt::Formatter) -> core::fmt::Result {
                        match *self {
                            Self::__Ignore(ref _0, ref _1) => fmt
                                .debug_tuple("View::__Ignore")
                                .field(&_0)
                                .field(&_1)
                                .finish(),
                            Self::free_balance { ref who } => fmt
                                .debug_struct("View::free_balance")
                                .field("who", &who)
                                .finish(),
                            Self::balances { ref who } => fmt
                                .debug_struct("View::balances")
                                .field("who", &who)
                                .finish(),
                        }
                    }
                ...
                impl<Runtime: Pip20> core::clone::Clone for View<Runtime> {
                    fn clone(&self) -> Self {
                        match self {
                            ...
                            Self::free_balance { ref who } => Self::free_balance {
                                who: core::clone::Clone::clone(who),
                            },
                            Self::balances { ref who } => Self::balances {
                                who: core::clone::Clone::clone(who),
                            },
                        }
                    }
                ...
                impl<Runtime: Pip20> core::cmp::PartialEq for View<Runtime> {
                    fn eq(&self, other: &Self) -> bool {
                        match (self, other) {
                            ...
                            (Self::free_balance { who }, Self::free_balance { who: _0 }) => {
                                true && who == _0
                            }
            ...
            const _: () = {
                ...
                impl<Runtime: Pip20> ::codec::Decode for View<Runtime> {
                    fn decode<__CodecInputEdqy: ::codec::Input>(
                        ...
                        match __codec_input_edqy.read_byte().map_err(|e| {
                            e.chain("Could not decode `View`, failed to read variant byte")
                        })? {
                            __codec_x_edqy if __codec_x_edqy == 0u8 as ::core::primitive::u8 => {
                                ::core::result::Result::Ok(View::<Runtime>::free_balance {
                                    who: {
                                        ...
                                        match __codec_res_edqy {
                                            ::core::result::Result::Err(e) => {
                                                return ::core::result::Result::Err(e.chain(
                                                    "Could not decode `View::free_balance::who`",
                                                ))
                                            }
                                            ::core::result::Result::Ok(__codec_res_edqy) => {
                                                __codec_res_edqy
                                ...
                                ::core::result::Result::Ok(View::<Runtime>::balances {
                                    who: {
                                        ...
                                        match __codec_res_edqy {
                                            ::core::result::Result::Err(e) => {
                                                return ::core::result::Result::Err(e.chain(
                                                    "Could not decode `View::balances::who`",
                                                ))
                                            }
                                            ::core::result::Result::Ok(__codec_res_edqy) => {
                                                __codec_res_edqy
                            ...
                            _ => {
                                ::core::result::Result::Err(<_ as ::core::convert::Into<_>>::into(
                                    "Could not decode `View`, variant doesn't exist",
                                ))
                            }
                        }
                    }
            ...
            impl<Runtime: Pip20> View<Runtime> {
                ...
                pub fn new_view_variant_free_balance(who: Runtime::AccountId) -> Self {
                    Self::free_balance { who }
                }
                ///Create a view with the variant `balances`.
                pub fn new_view_variant_balances(who: Runtime::AccountId) -> Self {
                    Self::balances { who }
                }
            }
                ...
                fn view(
                    ...
                    match self {
                        Self::free_balance { who } => {
                            ...
                            <Runtime as Pip20>::free_balance(select, who)
