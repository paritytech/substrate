...
fn storage_expand() {
    ...
    TestExternalities::default().execute_with(|| {
        ...
        assert_eq!(
            &k[..32],
            &<pallet::Map<Runtime, pallet::Instance1>>::final_prefix()
        );
        ...
        assert_eq!(
            &k[..32],
            &<pallet::Map2<Runtime, pallet::Instance1>>::final_prefix()
        );
        ...
        assert_eq!(
            &k[..32],
            &<pallet::DoubleMap<Runtime, pallet::Instance1>>::final_prefix()
        );
        ...
        assert_eq!(
            &k[..32],
            &<pallet::DoubleMap2<Runtime, pallet::Instance1>>::final_prefix()
        );
    });
}
...
fn metadata() {
    ...
    pretty_assertions::assert_eq!(
        pallet_instance1_metadata,
        expected_pallet_instance1_metadata
    );
}
