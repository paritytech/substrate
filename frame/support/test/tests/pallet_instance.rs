...
use frame_support::{
	...
	weights::{DispatchClass, DispatchInfo, GetDispatchInfo, Pays, Weight},
};
use sp_io::{
...
fn pallet_hooks_expand() {
	TestExternalities::default().execute_with(|| {
		...
		assert_eq!(AllPalletsWithoutSystem::on_initialize(1), Weight::from_computation(21));
		AllPalletsWithoutSystem::on_finalize(1);

		assert_eq!(AllPalletsWithoutSystem::on_runtime_upgrade(), Weight::from_computation(61));
