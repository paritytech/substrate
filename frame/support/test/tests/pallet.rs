...
fn pallet_hooks_expand() {
	TestExternalities::default().execute_with(|| {
		...
		assert_eq!(PalletInstancesRevExSystem::on_initialize(1), 10);
		PalletInstancesRevExSystem::on_finalize(1);

		assert_eq!(PalletInstancesRevExSystem::on_runtime_upgrade(), 30);
