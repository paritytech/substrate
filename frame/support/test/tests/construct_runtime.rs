...
fn pallet_in_runtime_is_correct() {
	...
	assert_eq!(PalletInfo::crate_name::<System>().unwrap(), "frame_support_test");
	...
	assert_eq!(PalletInfo::crate_name::<Module1_1>().unwrap(), "frame_support_test");
	...
	assert_eq!(PalletInfo::crate_name::<Module2>().unwrap(), "frame_support_test");
	...
	assert_eq!(PalletInfo::crate_name::<Module1_2>().unwrap(), "frame_support_test");
	...
	assert_eq!(PalletInfo::crate_name::<NestedModule3>().unwrap(), "frame_support_test");
	...
	assert_eq!(PalletInfo::crate_name::<Module3>().unwrap(), "frame_support_test");
	...
	assert_eq!(PalletInfo::crate_name::<Module1_3>().unwrap(), "frame_support_test");
	...
	assert_eq!(PalletInfo::crate_name::<Module1_4>().unwrap(), "frame_support_test");
	...
	assert_eq!(PalletInfo::crate_name::<Module1_5>().unwrap(), "frame_support_test");
	...
	assert_eq!(PalletInfo::crate_name::<Module1_6>().unwrap(), "frame_support_test");
	...
	assert_eq!(PalletInfo::crate_name::<Module1_7>().unwrap(), "frame_support_test");
	...
	assert_eq!(PalletInfo::crate_name::<Module1_8>().unwrap(), "frame_support_test");
	...
	assert_eq!(PalletInfo::crate_name::<Module1_9>().unwrap(), "frame_support_test");
