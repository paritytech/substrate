...
use frame_support::{CloneNoBound, DebugNoBound, EqNoBound, PartialEqNoBound, RuntimeDebugNoBound};
...
fn test_enum() {
    ...
    let variant_1 = TestEnum::VariantNamed {
        a: 1,
        b: 2,
        c: 3,
        phantom: Default::default(),
    };
    let variant_1_bis = TestEnum::VariantNamed {
        a: 1,
        b: 2,
        c: 4,
        phantom: Default::default(),
