...
pub trait OnRuntimeUpgrade {
	/// The state digest type, which is generated by `pre_upgrade` based on the pre-updrade
	/// state and will be passed to `post_upgrade` after upgrading for post-check. If there
	...
	///
	/// Return the state digest which will be passed to `post_upgrade` after upgrading for
	/// post-check. NOTE: if this function is not implemented, `Self::PreUpgradeState` should be set
	/// to `()`.
	///
	...
	///
	/// The state digest generated by `pre_upgrade` before upgrading will be passed in for
	/// post-check. NOTE: if `pre_upgrade` is not implemented, the default value of
	/// `Self::PreUpgradeState` will be used, in such case `Self::PreUpgradeState` should be set to
	/// `()`.
	///
	/// This hook is never meant to be executed on-chain but is meant to be used by testing tools.
	#[cfg(feature = "try-runtime")]
	fn post_upgrade(_digest: Self::PreUpgradeState) -> Result<(), &'static str> {
		Ok(())
	}
}
...
impl OnRuntimeUpgrade for Tuple {
	...
	fn post_upgrade(digest: Self::PreUpgradeState) -> Result<(), &'static str> {
		for_tuples!( #( Tuple::post_upgrade(digest.Tuple)?; )* );
		Ok(())
	}
}
...
///
/// The `PreUpgradeState` generic type parameter is used by `pre_upgrade` to generated
/// a state digest based on the pre-updrade state and will be passed to `post_upgrade`
/// after upgrading for post-check. If there is no such need, `()` should be used.
///
/// TODO: use the `associated_type_defaults` feature once it is stable.
pub trait Hooks<BlockNumber, PreUpgradeState: Default = ()> {
	/// The block is being finalized. Implement to have something happen.
	fn on_finalize(_n: BlockNumber) {}
	...
	///
	/// Return the state digest which will be passed to `post_upgrade` after upgrading for
	/// post-check. NOTE: if this function is not implemented, `PreUpgradeState` should be set
	/// to `()`.
	///
	/// This hook is never meant to be executed on-chain but is meant to be used by testing tools.
	#[cfg(feature = "try-runtime")]
	fn pre_upgrade() -> Result<PreUpgradeState, &'static str> {
		Ok(PreUpgradeState::default())
	}
	...
	/// The state digest generated by `pre_upgrade` before upgrading will be passed in for
	/// post-check. NOTE: if `pre_upgrade` is not implemented, the default value of
	/// `PreUpgradeState` will be used, in such case `PreUpgradeState` should be set to
	/// `()`.
	///
	/// This hook is never meant to be executed on-chain but is meant to be used by testing tools.
	#[cfg(feature = "try-runtime")]
	fn post_upgrade(_digest: PreUpgradeState) -> Result<(), &'static str> {
		Ok(())
	}
