...
pub trait OnRuntimeUpgrade {
	...
	/// post-check. NOTE: if this function is not implemented, `Self::PreStateDigest` should be set
	/// to `()`.
	///
	...
	/// `Self::PreStateDigest` will be used, in such case `Self::PreStateDigest` should be set to
	/// `()`.
	///
	/// This hook is never meant to be executed on-chain but is meant to be used by testing tools.
	#[cfg(feature = "try-runtime")]
	fn post_upgrade(_digest: Self::PreStateDigest) -> Result<(), &'static str> {
		Ok(())
	}
}
...
///
/// The `PreStateDigest` generic type parameter is used by `pre_upgrade` to generated
...
///
/// TODO: use the `associated_type_defaults` feature once it is stable.
pub trait Hooks<BlockNumber, PreStateDigest: Default = ()> {
	/// The block is being finalized. Implement to have something happen.
	fn on_finalize(_n: BlockNumber) {}
	...
	///
	/// Return the state digest which will be passed to `post_upgrade` after upgrading for
	/// post-check. NOTE: if this function is not implemented, `PreStateDigest` should be set
	/// to `()`.
	///
	/// This hook is never meant to be executed on-chain but is meant to be used by testing tools.
	#[cfg(feature = "try-runtime")]
	fn pre_upgrade() -> Result<PreStateDigest, &'static str> {
		Ok(PreStateDigest::default())
	}
	...
	/// The state digest generated by `pre_upgrade` before upgrading will be passed in for
	/// post-check. NOTE: if `pre_upgrade` is not implemented, the default value of
	/// `PreStateDigest` will be used, in such case `PreStateDigest` should be set to
	/// `()`.
	///
	/// This hook is never meant to be executed on-chain but is meant to be used by testing tools.
	#[cfg(feature = "try-runtime")]
	fn post_upgrade(_digest: PreStateDigest) -> Result<(), &'static str> {
		Ok(())
	}
