...
pub trait OnRuntimeUpgrade {
	...
	///
	/// Return the encoded state digest which will be passed to `post_upgrade` after upgrading for
	/// post-check.
	///
	...
	///
	/// The encoded state digest generated by `pre_upgrade` before upgrading will be passed in for
	/// post-check. NOTE: if `pre_upgrade` is not implemented an empty vec will be passed in, in
	/// such case `post_upgrade` should ignore it.
	///
	/// This hook is never meant to be executed on-chain but is meant to be used by testing tools.
	#[cfg(feature = "try-runtime")]
