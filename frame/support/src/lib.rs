...
pub mod pallet_macros {
	pub use frame_support_procedural::{
		...
		generate_store, genesis_build, genesis_config, getter, hooks, import_section, inherent, no_bounds,
		no_default, origin, pallet_section, storage, storage_prefix, storage_version, type_value,
		unbounded, validate_unsigned, verbatim, weight, whitelist_storage,
	};
}
