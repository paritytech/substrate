	...
	MaxValues: Get<Option<u32>>,
{
	...
	pub fn iter_prefix_from(
		...
		<Self as crate::storage::IterableStorageDoubleMap<Key1, Key2, Value>>::iter_prefix_from(k1, starting_key)
	}
	...
	/// specified `starting_key` in no particular order.
	///
	/// If you add or remove values whose first key is `k1` to the map while doing this, you'll get
	/// undefined results.
	pub fn iter_key_prefix_from(
		...
		<Self as crate::storage::IterableStorageDoubleMap<Key1, Key2, Value>>::iter_key_prefix_from(k1, starting_key)
	}
	...
	///
	/// If you add or remove values to the map while doing this, you'll get undefined results.
	pub fn iter_from(starting_key: Vec<u8>) -> crate::storage::PrefixIterator<(Key1, Key2, Value)> {
		<Self as crate::storage::IterableStorageDoubleMap<Key1, Key2, Value>>::iter_from(starting_key)
	}
	...
	///
	/// If you add or remove values to the map while doing this, you'll get undefined results.
	pub fn iter_keys_from(starting_key: Vec<u8>) -> crate::storage::KeyPrefixIterator<(Key1, Key2)> {
		<Self as crate::storage::IterableStorageDoubleMap<Key1, Key2, Value>>::iter_keys_from(starting_key)
	}
