...
pub trait Staking<AccountId, Currency: Currency<AccountId>> {
	type EraIndex;

	fn exposure(when: Self::EraIndex, which: &AccountId) -> Exposure;
...
pub trait Trait: frame_system::Trait {
	...
	/// The staking module trait.
	type Staking: Staking<Self::AccountId, Self::Currency>;
}
