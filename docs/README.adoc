...
Or just run the tests of a specific package (i.e. `cargo test -p palette-assets`)
...
[source, shell]
palette-assets, palette-balances, palette-consensus, palette-contracts, palette-council, palette-democracy, palette-example,
palette-executive, palette-metadata, palette-session, palette-staking, palette-support, palette-system, palette-timestamp,
palette-treasury
* Node
[source, shell]
