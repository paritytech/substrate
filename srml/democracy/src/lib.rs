...
decl_module! {
	pub struct Module<T: Trait> for enum Call where origin: T::Origin {
		fn propose(SystemOrigin(Signed(who)), proposal: Box<T::Proposal>, value: T::Balance) -> Result;
		fn second(SystemOrigin(Signed(who)), proposal: PropIndex) -> Result;
		fn vote(SystemOrigin(Signed(who)), ref_index: ReferendumIndex, approve_proposal: bool) -> Result;
...
impl<T: Trait> Module<T> {
	...
	fn propose(who: T::AccountId, proposal: Box<T::Proposal>, value: T::Balance) -> Result {
	...
	/// Propose a sensitive action to be taken.
	fn second(who: T::AccountId, proposal: PropIndex) -> Result {
	...
	fn vote(who: T::AccountId, ref_index: ReferendumIndex, approve_proposal: bool) -> Result {
