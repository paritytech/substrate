...
impl<T: Trait> ProvideInherent for Module<T> {
    ...
    fn create_inherent(data: &InherentData) -> Option<Self::Call> {
        let final_num = data
            .finalized_number()
            .expect("Gets and decodes final number inherent data");
...
mod tests {
    ...
    use primitives::traits::{BlakeTwo256, Header as HeaderT, IdentityLookup, OnFinalize};
        ...
        () => {
            ...
            impl OnFinalizationStalled<u64> for StallTracker {
                fn on_stalled(further_wait: u64) {
                    ...
                    NOTIFICATIONS.lock().push(StallEvent {
                        at: now,
                        further_wait,
                    });
                }
