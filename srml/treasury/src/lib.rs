...
use srml_support::traits::{Currency, Imbalance, OnDilution, OnUnbalanced, ReservableCurrency};
...
mod tests {
    ...
    use runtime_primitives::traits::{BlakeTwo256, IdentityLookup, OnFinalize};
