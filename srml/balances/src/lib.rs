	...
	T::Balance: MaybeSerializeDebug
{
	...
	fn free_balance(who: &T::AccountId) -> Self::Balance {
		<FreeBalance<T, Instance>>::get(who)
	}

	fn reserved_balance(who: &T::AccountId) -> Self::Balance {
		<ReservedBalance<T, Instance>>::get(who)
	}
...
impl<T: Trait<Instance>, Instance: 'static + Instantiable> LockableCurrency<T::AccountId> for Module<T, Instance>
where
	T::Balance: MaybeSerializeDebug
{
	...
	fn set_lock(
		...
		<Locks<T, Instance>>::insert(who, locks);
	}
