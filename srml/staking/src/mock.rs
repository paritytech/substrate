...
use crate::{GenesisConfig, Module, StakerStatus, Trait};
...
impl ExtBuilder {
    ...
    pub fn build(self) -> runtime_io::TestExternalities<Blake2Hasher> {
        ...
        let _ = session::GenesisConfig::<Test> {
            ...
            validators: if self.validator_pool {
                vec![10, 20, 30, 40]
            } else {
                vec![10, 20]
            },
            ...
            stakers: if self.validator_pool {
                vec![
                    (
                        ...
                        10,
                        balance_factor * 1000,
                        StakerStatus::<AccountIdType>::Validator,
                    ),
                    (
                        21,
                        20,
                        balance_factor * if self.fare { 1000 } else { 2000 },
                        StakerStatus::<AccountIdType>::Validator,
                    ),
                    (
                        31,
                        ...
                        if self.validator_pool {
                            ...
                            StakerStatus::<AccountIdType>::Idle
                        },
                    ),
                    (
                        41,
                    ...
                    (
                        ...
                        balance_factor * 500,
                        if self.nominate {
                            StakerStatus::<AccountIdType>::Nominator(vec![11, 21])
                        } else {
                            StakerStatus::<AccountIdType>::Nominator(vec![])
                        },
                    ),
                ]
            } else {
