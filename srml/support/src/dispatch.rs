...
/// }
/// ```
/// *Where `...` indicates truncated code for example brevity.*
/// 
/// Function declaration is set with the header where:
...
/// * [Optional] Public functions: `pub` functions are easily accessible to other modules, e.g. `foo()`.
...
/// * `offchain_worker`: Starts at the beginning of the block and produces extrinsics for the next block.
/// 
