...
/// 			OK(())
/// 		}
///			pub fn foo(origin) -> Result {...}  // public function easily accessible to other modules
///			fn bar(origin) {...}				// macro expands to return `Result`
///			fn baz() -> Result {...}			// privileged function
///		}
/// }
/// ```
///
...
/// * [Optional] Privileged calls: if the `origin` param is omitted, the macro assumes the `origin`
///   to be `Root`, e.g. `baz`.
///
/// ## Special Functions
///
...
/// * `offchain_worker`: Starts at the beginning of a block and produces extrinsics for the next block.
///
