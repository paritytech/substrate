...
pub use srml_metadata::{
    DecodeDifferent, DefaultByteGetter, FnEncode, ModuleMetadata, RuntimeMetadata,
    RuntimeMetadataPrefixed, RuntimeMetadataV3,
};
...
mod tests {
    ...
    use srml_metadata::{
        EventMetadata, FunctionMetadata, ModuleMetadata, RuntimeMetadataPrefixed,
        StorageFunctionMetadata, StorageFunctionModifier, StorageFunctionType,
    };
    ...
    const EXPECTED_METADATA: RuntimeMetadata = RuntimeMetadata::V3(RuntimeMetadataV3 {
