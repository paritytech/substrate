...
use srml_support::codec::{Decode, Encode};
use srml_support::rstd;
use srml_support::rstd::prelude::*;
use srml_support::runtime_primitives::traits::{BlakeTwo256, Block as _, Digest, Verify};
...
mod module2 {
    ...
    pub type Log<T, I = DefaultInstance> = RawLog<T, I>;
