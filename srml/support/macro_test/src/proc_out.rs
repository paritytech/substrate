...
impl self :: sr_api_hidden_includes_construct_runtime :: hidden_include :: sr_primitives :: traits :: GetNodeBlockType for Runtime { type NodeBlock = Block ; }
impl self :: sr_api_hidden_includes_construct_runtime :: hidden_include :: sr_primitives :: traits :: GetRuntimeBlockType for Runtime { type RuntimeBlock = Block ; }
...
impl ::sr_primitives::BuildStorage for GenesisConfig {
    fn assimilate_storage(
        ...
        if let Some(extra) = self.staking {
            ::sr_primitives::BuildModuleGenesisStorage::<
                    Runtime,
                    staking::__InherentHiddenInstance,
                >::build_module_genesis_storage(extra, storage)?;
        }
        if let Some(extra) = self.session {
            ::sr_primitives::BuildModuleGenesisStorage::<
                    Runtime,
                    session::__InherentHiddenInstance,
                >::build_module_genesis_storage(extra, storage)?;
        }
        ...
        if let Some(extra) = self.grandpa {
            ::sr_primitives::BuildModuleGenesisStorage::<
                    Runtime,
                    grandpa::__InherentHiddenInstance,
                >::build_module_genesis_storage(extra, storage)?;
        }
