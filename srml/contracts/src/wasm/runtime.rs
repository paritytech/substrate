...
define_env!(Env, <E: Ext>,
	...
	// Attempt to restore the specified contract.
	//
	// This will compute a tombstone hash from the caller's storage and the given code hash and
	// if the hash matches the hash found in the tombstone at the specified address - kill the
	// caller contract and restore the destination contract and set the specified `rent_allowance`.
