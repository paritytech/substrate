...
// /// function there exists [`Client`]. However, the problem on how to use this client instance
// still /// exists. This trait "solves" it in a dirty way. It requires a type to implement this
// trait and /// than the [`execute_with_client`](ExecuteWithClient::execute_with_client) function
...
// 		Api: sp_api::ApiExt<sp_runtime::generic::Block<sp_runtime::generic::Header<u32,
// sp_runtime::traits::BlakeTwo256>, sp_runtime::OpaqueExtrinsic>>; }
...
// each runtime has a /// specialized client, we need to hide them behind a trait. This is this
// trait. ///
		...
		+ 'static,
{
	...
	//let (client, fork_choice_rule) =
	// builder.build_with_executor(NativeElseWasmExecutor::new(WasmExecutionMethod::Interpreted,
	// None, 8));
