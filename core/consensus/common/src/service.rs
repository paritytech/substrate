...
use super::{evaluation, offline_tracker, InherentData, Environment, Proposer as ProposerTrait, MAX_TRANSACTIONS_SIZE};

use parking_lot::RwLock;

/// Shared offline validator tracker.
pub type SharedOfflineTracker = Arc<RwLock<offline_tracker::OfflineTracker>>;
type Timestamp = u64;
...
impl<C, A> Environment<<C as AuthoringApi>::Block> for ProposerFactory<C, A> where
	C: AuthoringApi,
...
impl<Block, C, A> ProposerTrait<<C as AuthoringApi>::Block> for Proposer<Block, C, A> where
	Block: BlockT,
