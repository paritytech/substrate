...
use schnorrkel::{
	...
	keys::Keypair,
	vrf::{VRFProof, VRF_PROOF_LENGTH, VRFInOut},
...
/// Hash used to generate the VRF input point.  Generated by
///
/// ```sh
/// printf 'Substrate BABE Input Point' |
/// openssl sha256 -binary |
/// xxd -i
/// ```
///
/// and then reformatting.
pub const VRF_INPUT_POINT_SEED: [u8; 32] = [
	0x11, 0xc8, 0x51, 0x91, 0x7f, 0xd9, 0x43, 0xc1, 0xbb, 0x75, 0x38, 0x6e,
	0x02, 0x0e, 0x39, 0x9c, 0x98, 0x5c, 0x73, 0x27, 0xb2, 0x0c, 0x04, 0x7c,
	0x71, 0x9a, 0x08, 0x19, 0x2d, 0x3d, 0x2e, 0xb9,
];

/// Hash used to generate the VRF output point.  Generated by
///
/// ```sh
/// printf 'Substrate BABE Output Point' |
/// openssl sha256 -binary |
/// xxd -i
/// ```
///
/// and then reformatting.
pub const VRF_OUTPUT_POINT_SEED: [u8; 32] = [
	0xd3, 0xae, 0xed, 0x58, 0x8e, 0xbe, 0x53, 0x29, 0x1a, 0x17, 0x59, 0x1a,
	0x34, 0x74, 0x8f, 0x3c, 0xcf, 0xaa, 0xea, 0x2d, 0xfb, 0xb1, 0xb1, 0xe3,
