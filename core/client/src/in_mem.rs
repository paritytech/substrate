...
use runtime_primitives::{ChildrenStorageOverlay, Justification, StorageOverlay};
use state_machine::backend::{Backend as StateBackend, Consolidate, InMemory};
use state_machine::{self, ChangesTrieAnchorBlockId, InMemoryChangesTrieStorage};
    ...
    H::Out: HeapSizeOf,
{
    fn root(
        &self,
        anchor: &ChangesTrieAnchorBlockId<H::Out>,
        block: u64,
