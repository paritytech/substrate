...
impl<Block: BlockT> client::backend::PrunableStateChangesTrieStorage<Block>
...
impl<Block: BlockT> Backend<Block> {
	...
	fn from_kvdb(
		...
		let map_e = |e: state_db::Error<io::Error>| client::error::Error::from(
...
impl<Block> client::backend::AuxStore for Backend<Block> where Block: BlockT {
	fn insert_aux<
		'a,
		'b: 'a,
		'c: 'a,
