...
use runtime_primitives::traits::{Block as BlockT, Header as HeaderT, As, NumberFor, Zero, Digest, DigestItem, BlockAuthorityId};
...
where Block: BlockT<Hash=H256>,
{
	...
	fn update_authorities(&mut self, _authorities: Vec<BlockAuthorityId<Block>>) {
