...
impl<Block: BlockT, T: CacheItemT> Entry<Block, T> {
    ...
    pub fn search_best_range_before<S: Storage<Block, T>>(
        ...
        Ok(self
            .search_best_before(storage, block, false)?
...
mod tests {
    ...
    fn entry_search_best_before_fails() {
        ...
        .search_best_before(&FaultyStorage, 50, false)
        .is_err());
    }
    ...
    fn entry_search_best_before_works() {
        ...
        assert_eq!(
            ...
            .search_best_before(&DummyStorage::new(), 150, false)
            .unwrap(),
            Some((
                Entry::<_, u64> {
                    valid_from: test_id(100),
        ...
        assert_eq!(
            ...
            .search_best_before(&DummyStorage::new(), 150, true)
            .unwrap(),
            Some((
                Entry::<_, u64> {
                    valid_from: test_id(100),
