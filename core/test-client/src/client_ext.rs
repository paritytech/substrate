...
use consensus::{
    BlockImport, BlockOrigin, Error as ConsensusError, ForkChoiceStrategy, ImportBlock,
};
...
pub trait TestClient: Sized {
    ...
    fn import(&self, origin: BlockOrigin, block: runtime::Block) -> Result<(), ConsensusError>;
