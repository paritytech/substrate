...
/// Key-value storage type definition.
///
/// - Key is a `Vec<u8>`
/// - Value is an `Option<Vec<u8>>` while `None` means that the value was deleted
pub type KeyValueStorage = HashMap<Vec<u8>, Option<Vec<u8>>>;
...
pub struct StorageChanges<B: Backend<H>, H: Hasher, N: BlockNumber> {
	...
	pub main_storage_changes: KeyValueStorage,
	/// All changes to the child storages.
	pub child_storage_changes: HashMap<Vec<u8>, KeyValueStorage>,
