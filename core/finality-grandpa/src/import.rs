...
use runtime_primitives::traits::{
    Block as BlockT, DigestFor, DigestItem, DigestItemFor, Header as HeaderT, NumberFor,
    ProvideRuntimeApi,
};
    ...
    PRA::Api: GrandpaApi<Block>,
{
    ...
    fn make_authorities_changes<'a>(
        ...
        if let Some((_, ref authorities)) = just_in_case {
            ...
            crate::aux_schema::update_authority_set(authorities, authorities_change, |insert| {
                block
                    .auxiliary
