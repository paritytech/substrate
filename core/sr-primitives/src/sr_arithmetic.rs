...
macro_rules! implement_per_thing {
	($name:ident, $test_mod:ident, [$($test_units:tt),+], $max:tt, $type:ty, $upper_type:ty, $title:expr $(,)?) => {
		...
		#[derive(Encode, Decode, Default, Copy, Clone, PartialEq, Eq, primitives::RuntimeDebug)]
...
#[derive(Encode, Decode, Default, Copy, Clone, PartialEq, Eq, PartialOrd, Ord, primitives::RuntimeDebug)]
...
#[derive(Clone, Copy, Default, Eq, primitives::RuntimeDebug)]
