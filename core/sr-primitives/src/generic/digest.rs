...
gen_digest_type! {
	...
	pub enum ConsensusDigest<SealSignature> {
		...
		Inherent((ConsensusEngineId, Vec<u8>), (a, b)),
	}
	...
	/// A digest item that is reserved for system use. Consensus engines and
	/// runtimes **MUST NOT** push digests in this variant. This **SHOULD** be
	/// detected at compile time.  If it is not, the behavior of the blockchain
	/// is undefined. The SRML itself is exempt from this prohibition.
