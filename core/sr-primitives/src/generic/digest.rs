...
use traits::{self, Member, DigestItem as DigestItemT, MaybeSerializeDebugButNotDeserialize};
...
impl<
	Hash: Codec + Member + MaybeSerializeDebugButNotDeserialize,
	AuthorityId: Codec + Member + MaybeSerializeDebugButNotDeserialize
