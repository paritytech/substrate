...
use crate::codec::{Codec, Decode, Encode, Input};
use crate::traits::{self, DigestItem as DigestItemT, MaybeHash, Member};
...
#[cfg(feature = "std")]
impl<Hash: Encode, AuthorityId: Encode, SealSignature: Encode> ::serde::Serialize
    ...
    for DigestItem<Hash, AuthorityId, SealSignature>
{
    ...
    fn decode<I: Input>(input: &mut I) -> Option<Self> {
        ...
        match item_type {
            ...
            DigestItemType::Other => Some(DigestItem::Other(Decode::decode(input)?)),
        }
    }
}

impl<'a, Hash: Codec + Member, AuthorityId: Codec + Member, SealSignature: Codec + Member>
...
#[allow(deprecated)]
impl<'a, Hash: Encode, AuthorityId: Encode, SealSignature: Encode> Encode
