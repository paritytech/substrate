...
#[cfg(feature = "std")]
use crate::crypto::{Derive, DeriveJunction, Pair as TraitPair, SecretStringError};
#[cfg(feature = "std")]
...
impl TraitPair for Pair {
    ...
    fn generate() -> Pair {
        ...
        SystemRandom::new()
            .fill(seed.as_mut())
            .expect("system random source should always work! qed");
        Self::from_seed(seed)
    }
...
mod test {
    ...
    fn test_vector_by_string_should_work() {
        let pair: Pair = Pair::from_string(
