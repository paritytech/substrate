...
#[derive(Debug, Clone)]
pub enum Event {
	/// Opened a new TCP/IP (or other similar reliable transport) with the given node through the
	/// given endpoint.
	Connected(PeerId, ConnectedPoint),

	/// Closed a TCP/IP (or other transport) with the given node. It was using the given endpoint.
