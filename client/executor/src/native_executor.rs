...
impl<D: NativeExecutionDispatch> RuntimeInfo for NativeExecutor<D> {
    ...
    fn runtime_version(
        ...
        self.wasm
            .with_instance(runtime_code, ext, |_instance, version, _ext| {
                Ok(version
                    .cloned()
...
impl<D: NativeExecutionDispatch + 'static> CodeExecutor for NativeExecutor<D> {
    ...
    >(
        ...
        let result =
            self.wasm
                .with_instance(runtime_code, ext, |instance, onchain_version, mut ext| {
                    let onchain_version =
...
impl<D: NativeExecutionDispatch> sp_core::traits::CallInWasm for NativeExecutor<D> {
    fn call_in_wasm(
        ...
        self.wasm
            .call_in_wasm(wasm_blob, code_hash, method, call_data, ext)
    }
}
