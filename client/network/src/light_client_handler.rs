...
use crate::{chain::Client, config::ProtocolId, protocol::message::BlockAttributes, schema};
use bytes::Bytes;
    ...
    B: Block,
{
    ...
    fn on_remote_changes_request(
        ...
        let proof = match self
            .chain
            .key_changes_proof(first, last, min, max, storage_key, &key)
        {
            Ok(proof) => proof,
            Err(error) => {
                log::trace!(
