    ...
    fn inject_event(&mut self, event: CustomMessageOutcome<B>) {
        match event {
            ...
            CustomMessageOutcome::JustificationImport(origin, hash, nb, justification) => {
                self.events.push(BehaviourOut::JustificationImport(
                    origin,
                    hash,
                    nb,
                    justification,
            ...
            CustomMessageOutcome::FinalityProofImport(origin, hash, nb, proof) => self
                .events
                .push(BehaviourOut::FinalityProofImport(origin, hash, nb, proof)),
        ...
        match out {
            ...
            DiscoveryOut::RandomKademliaStarted(protocols) => {
                for protocol in protocols {
                    self.events
                        .push(BehaviourOut::RandomKademliaStarted(protocol));
                }
            }
        }
    }
