...
use crate::protocol::generic_proto::upgrade::{
    ...
    NotificationsOutSubstream, RegisteredProtocol, RegisteredProtocolEvent,
    RegisteredProtocolSubstream, UpgradeCollec,
};
...
use libp2p::core::upgrade::{InboundUpgrade, OutboundUpgrade, SelectUpgrade};
