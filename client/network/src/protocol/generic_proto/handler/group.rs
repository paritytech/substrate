        ...
        if let Poll::Ready(ev) = self.legacy.poll(cx) {
            return match ev {
                ...
                ProtocolsHandlerEvent::Custom(LegacyProtoHandlerOut::CustomProtocolOpen {
                    endpoint,
                    ..
                }) => Poll::Ready(ProtocolsHandlerEvent::Custom(NotifsHandlerOut::Open {
                    endpoint,
                })),
                ProtocolsHandlerEvent::Custom(LegacyProtoHandlerOut::CustomProtocolClosed {
                    endpoint,
                    reason,
                }) => Poll::Ready(ProtocolsHandlerEvent::Custom(NotifsHandlerOut::Closed {
                    endpoint,
                    reason,
                })),
                ...
                ProtocolsHandlerEvent::Custom(LegacyProtoHandlerOut::Clogged { messages }) => {
                    Poll::Ready(ProtocolsHandlerEvent::Custom(NotifsHandlerOut::Clogged {
                        messages,
                    }))
                }
