...
use sc_client_api::{Backend, BlockchainEvents, ExecutorProvider, StorageProvider};
    ...
    Client: Send + Sync + 'static,
{
    ...
    fn child_storage_size(
        ...
        Box::new(
            self.child_storage(block, child_storage_key, child_info, child_type, key)
                .map(|x| x.map(|x| x.0.len() as u64)),
        )
    }
    ...
    Client: Send + Sync + 'static,
{
    ...
    fn child_storage_keys(
        ...
        self.backend.child_storage_keys(
            block,
            child_storage_key,
            child_info,
            child_type,
    ...
    fn child_storage_hash(
        ...
        self.backend
            .child_storage_hash(block, child_storage_key, child_info, child_type, key)
    }
    ...
    fn child_storage_size(
        ...
        self.backend
            .child_storage_size(block, child_storage_key, child_info, child_type, key)
    }
