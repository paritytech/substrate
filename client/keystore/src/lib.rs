...
use sp_application_crypto::{ed25519, sr25519, AppKey, AppPair, AppPublic};
use sp_core::{
    crypto::{CryptoTypePublicPair, IsWrappedBy, KeyTypeId, Pair as PairT, Protected, Public},
...
impl BareCryptoStore for Store {
    ...
    fn has_keys(&self, public_keys: &[(Vec<u8>, KeyTypeId)]) -> bool {
        public_keys
            .iter()
            .all(|(p, t)| self.key_phrase_by_type(&p, *t).is_ok())
    }
}
