...
use sp_consensus::import_queue::{BasicQueue, BoxBlockImport, Verifier};
use sp_consensus::{
...
impl<B: BlockT, I: Clone, C, S: Clone, Algorithm: Clone> Clone
    for PowBlockImport<B, I, C, S, Algorithm>
{
    fn clone(&self) -> Self {
        Self {
...
impl<B, I, C, S, Algorithm> PowBlockImport<B, I, C, S, Algorithm>
where
    B: BlockT,
...
impl<B, I, C, S, Algorithm> BlockImport<B> for PowBlockImport<B, I, C, S, Algorithm>
where
    B: BlockT,
    I: BlockImport<B, Transaction = sp_api::TransactionFor<C, B>> + Send + Sync,
    I::Error: Into<ConsensusError>,
