...
pub use sysinfo::{
	...
	benchmark_memory, benchmark_sr25519_verify, deserialize_throughput, gather_hwbench,
	gather_sysinfo, serialize_throughput, serialize_throughput_as_mibs,
	serialize_throughput_option_as_mibs, Throughput,
};
