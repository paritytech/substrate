...
impl<Block: BlockT, T: CacheItemT, S: Storage<Block, T>> ListCache<Block, T, S> {
    ...
    fn destroy_abandoned_forks<Tx: StorageTransaction<Block, T>>(
        ...
        let mut destroyed = prev_abandoned_forks
            .cloned()
...
pub mod tests {
    ...
    fn list_transaction_commit_works() {
        ...
        cache.on_transaction_commit(
            vec![CommitOperation::AppendNewEntry(
                0,
                Entry {
        ...
        cache.on_transaction_commit(
            vec![CommitOperation::AddNewFork(Entry {
    ...
    fn revert_block_works() {
        ...
        let op = cache
            .do_on_block_revert(&mut DummyTransaction::new(), &correct_id(5))
            .unwrap();
        assert_eq!(
            op,
        ...
        let op = cache
            .do_on_block_revert(&mut DummyTransaction::new(), &correct_id(3))
            .unwrap();
        assert_eq!(
            op,
        ...
        let op = cache
            .do_on_block_revert(&mut DummyTransaction::new(), &correct_id(2))
            .unwrap();
        assert_eq!(
            op,
