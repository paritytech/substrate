...
mod tests {
	...
	fn test_leaves_with_complex_block_tree() {
		let backend: Arc<Backend<test_sc_client::runtime::Block>> = Arc::new(Backend::new_test(20, 20));
		test_sc_client::trait_tests::test_leaves_for_backend(backend);
	}

	#[test]
	fn test_children_with_complex_block_tree() {
		let backend: Arc<Backend<test_sc_client::runtime::Block>> = Arc::new(Backend::new_test(20, 20));
		test_sc_client::trait_tests::test_children_for_backend(backend);
	}

	#[test]
	fn test_blockchain_query_by_number_gets_canonical() {
		let backend: Arc<Backend<test_sc_client::runtime::Block>> = Arc::new(Backend::new_test(20, 20));
		test_sc_client::trait_tests::test_blockchain_query_by_number_gets_canonical(backend);
	}
	...
	#[test]
	fn test_aux() {
		let backend: Backend<test_sc_client::runtime::Block> = Backend::new_test(0, 0);
