...
use sp_core::{H256, ChangesTrieConfiguration, blake2_256, testing::SpawnBlockingExecutor};
...
fn construct_block(
	...
	let task_executor = Box::new(SpawnBlockingExecutor::new());
...
fn cleans_up_closed_notification_sinks_on_block_import() {
	...
	let mut client =
		...
		>(
			...
			None,
			None,
			Box::new(SpawnBlockingExecutor::new()),
			Default::default(),
		)
			.unwrap();
