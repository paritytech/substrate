...
use tracing::{
    event::Event,
    span::{Attributes, Id, Record, Span},
...
type TestSubscriber =
    tracing_subscriber::layer::Layered<TestLayer, tracing_subscriber::fmt::Subscriber>;

fn setup_subscriber() -> (TestSubscriber, Arc<Mutex<Vec<String>>>) {
