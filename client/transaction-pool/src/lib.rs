...
use sp_runtime::{
	generic::BlockId,
	traits::{Block as BlockT, NumberFor, RuntimeArithmetic, Extrinsic},
};
...
impl<N: Clone + Copy + RuntimeArithmetic> RevalidationStrategy<N> {
...
impl<N: Clone + Copy + RuntimeArithmetic> RevalidationStatus<N> {
