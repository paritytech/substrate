...
fn register_finality_tracker_inherent_data_provider<B, E, Block: BlockT<Hash=H256>, RA>(
	...
	RA: Send + Sync + 'static,
{
	if !inherent_data_providers.has_provider(&palette_finality_tracker::INHERENT_IDENTIFIER) {
		inherent_data_providers
			.register_provider(palette_finality_tracker::InherentDataProvider::new(move || {
				#[allow(deprecated)]
				{
