...
use runtime_primitives::traits::{BlindCheckable, BlakeTwo256, StubDigestItem};
...
pub type Digest = runtime_primitives::generic::Digest<StubDigestItem>;
/// A test block.
pub type Block = runtime_primitives::generic::Block<Header, Extrinsic>;
/// A test block's header.
pub type Header = runtime_primitives::generic::Header<BlockNumber, BlakeTwo256, StubDigestItem>;
