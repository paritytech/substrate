...
use {BlockBuilder, BlitzApi, LocalBlitzApi, ErrorKind, Error, Result};
...
impl<B: LocalBackend<Block>> BlitzApi for Client<B, LocalCallExecutor<B, NativeExecutor<LocalDispatch>>, Block> {
...
impl<B: LocalBackend<Block>> LocalBlitzApi for Client<B, LocalCallExecutor<B, NativeExecutor<LocalDispatch>>, Block>
{}
