...
use {BlitzApi, BlockBuilder, RemoteBlitzApi, Result, ErrorKind};
...
/// Remote blitz API implementation.
pub struct RemoteBlitzApiWrapper<B: Backend<Block>, E: CallExecutor<Block>>(pub Arc<Client<B, E, Block>>);

impl<B: Backend<Block>, E: CallExecutor<Block>> BlitzApi for RemoteBlitzApiWrapper<B, E> {
...
impl<B: RemoteBackend<Block>, E: CallExecutor<Block>> RemoteBlitzApi for RemoteBlitzApiWrapper<B, E> {}
