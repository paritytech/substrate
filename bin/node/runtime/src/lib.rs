...
parameter_types! {
	pub const MixnetNumCoverToCurrentBlocks: BlockNumber = 10;
	pub const MixnetNumRequestsToCurrentBlocks: BlockNumber = 10;
	pub const MixnetNumCoverToPrevBlocks: BlockNumber = 10;
	pub const MixnetNumRegisterStartSlackBlocks: BlockNumber = 5;
	pub const MixnetNumRegisterEndSlackBlocks: BlockNumber = 10;
