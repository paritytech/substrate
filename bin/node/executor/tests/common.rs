...
pub const SPEC_VERSION: u32 = node_kitchensink_runtime::VERSION.spec_version;

pub const TRANSACTION_VERSION: u32 = node_kitchensink_runtime::VERSION.transaction_version;
