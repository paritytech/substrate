...
pub fn create_extrinsic(
	...
	function: impl Into<node_kitchensink_runtime::Call>,
	nonce: Option<u32>,
) -> node_kitchensink_runtime::UncheckedExtrinsic {
	...
	let period = node_kitchensink_runtime::BlockHashCount::get()
		.checked_next_power_of_two()
		.map(|c| c / 2)
		.unwrap_or(2) as u64;
	let tip = 0;
	let extra: node_kitchensink_runtime::SignedExtra = (
		frame_system::CheckNonZeroSender::<node_kitchensink_runtime::Runtime>::new(),
		frame_system::CheckSpecVersion::<node_kitchensink_runtime::Runtime>::new(),
		frame_system::CheckTxVersion::<node_kitchensink_runtime::Runtime>::new(),
		frame_system::CheckGenesis::<node_kitchensink_runtime::Runtime>::new(),
		frame_system::CheckEra::<node_kitchensink_runtime::Runtime>::from(generic::Era::mortal(
			period,
	...
	let raw_payload = node_kitchensink_runtime::SignedPayload::from_raw(
		...
		(
			(),
			node_kitchensink_runtime::VERSION.spec_version,
			node_kitchensink_runtime::VERSION.transaction_version,
			genesis_hash,
			best_hash,
			(),
			(),
	...
	node_kitchensink_runtime::UncheckedExtrinsic::new_signed(
		function,
		sp_runtime::AccountId32::from(sender.public()).into(),
		node_kitchensink_runtime::Signature::Sr25519(signature),
		extra,
	)
}
