...
COPY --from=smart-contracts /smart-contracts/cere01/target/ink/cere01.wasm /cerenetwork/frame/ddc-metrics-offchain-worker/src/tests/test_data
COPY --from=smart-contracts /smart-contracts/cere01/target/ink/metadata.json /cerenetwork/frame/ddc-metrics-offchain-worker/src/tests/test_data
